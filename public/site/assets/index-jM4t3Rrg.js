(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const x=[];function T(t,a){const i=[],n=new RegExp("^"+t.replace(/\//g,"\\/").replace(/:([a-zA-Z]+)/g,(o,s)=>(i.push(s),"([^/]+)"))+"$");x.push({regex:n,keys:i,handler:a})}function ne(t){const a=t.indexOf("#"),i=a>=0?t.slice(a+1):"",n=a>=0?t.slice(0,a)||"/":t;window.history.pushState({},"",i?`${n}#${i}`:n),I(),i&&requestAnimationFrame(()=>{var o;(o=document.getElementById(i))==null||o.scrollIntoView({behavior:"smooth"})})}function S(){return window.location.pathname.replace(/\/+$/,"")||"/"}function I(){var a;const t=S();for(const i of x){const n=t.match(i.regex);if(!n)continue;const o={};i.keys.forEach((s,r)=>{o[s]=decodeURIComponent(n[r+1])}),i.handler(o);return}(a=x.find(i=>i.regex.source==="^\\/$"))==null||a.handler({})}function oe(){document.addEventListener("click",t=>{const a=t.target.closest("a[data-navigate]");a&&(t.metaKey||t.ctrlKey||t.shiftKey||t.altKey||(t.preventDefault(),ne(a.getAttribute("href"))))}),window.addEventListener("popstate",I),I()}const U={sq:{navLabel:"Kryesore",langLabel:"Gjuha",features:"Veçoritë",howItWorks:"Si funksionon",packages:"Paketat",faq:"FAQ",blog:"Blog",backToTop:"Kthehu lart",blogBadge:"Blog",heroTitle:"Këshilla & Njohuri për",heroAccent:"Restorante Moderne",heroSubtitle:"Artikuj praktikë për menaxhimin e restorantit, teknologjinë POS dhe eficiencën operacionale.",readMore:"Lexo →",backToBlog:"← Kthehu në ballina",pageTitle:"Revolution Invest POS — Restorante & Kafene",metaDescription:"Këshilla dhe njohuri për restorante moderne — menaxhim, POS, teknologji dhe eficiencë operacionale."},en:{navLabel:"Main navigation",langLabel:"Language",features:"Features",howItWorks:"How it works",packages:"Pricing",faq:"FAQ",blog:"Blog",backToTop:"Back to top",blogBadge:"Blog",heroTitle:"Tips & Insights for",heroAccent:"Modern Restaurants",heroSubtitle:"Practical articles on restaurant management, POS technology, and operational efficiency.",readMore:"Read →",backToBlog:"← Back to home",pageTitle:"Revolution Invest POS — Restaurants & Cafés",metaDescription:"Tips and insights for modern restaurants — management, POS, technology, and operational efficiency."}},M={sq:{"meta.title":"Revolution Invest POS — Sistemi POS për Restorantet, Kafenetë & Dyqanet","meta.description":"Revolution Invest POS — platformë e plotë për restorante, kafene dhe dyqane. POS, kuzhinë, kamarier, faqe publike /r/ & /s/, porosi online dhe offline me sync.","brand.subtitle":"Restorant · Kafene · Dyqan","nav.home":"Ballina","nav.howItWorks":"Si funksionon","nav.getStarted":"Si ta ngarkoni","nav.packages":"Pakot","nav.equipment":"Pajisjet","nav.blog":"Blog","nav.manual":"Manuali","nav.contact":"Kontakti","nav.openMenu":"Hap menunë","getStarted.title":"Si ta ngarkoni programin — hap pas hapi","getStarted.subtitle":"Merrni linkun zyrtar të Setup me Email, SMS ose WhatsApp — pastaj instaloni dhe aktivizoni.","getStarted.s1.title":"1. Zgjidhni pakon","getStarted.s1.desc":"Shikoni Pakot (Standard, Pro, Full ose AI) dhe zgjidhni atë që ju duhet.","getStarted.s2.title":"2. Shkarkoni Setup","getStarted.s2.desc":"Kërkoni link zyrtar me Email, SMS ose WhatsApp — hapeni në kompjuter dhe shkarkoni .exe.","getStarted.s3.title":"3. Instaloni programin","getStarted.s3.desc":"Hapni Setup.exe dhe ndiqni dritaren e instalimit (Windows).","getStarted.s4.title":"4. Hapni aktivizimin","getStarted.s4.desc":"Në fund hapet «Aktivizo KAFENE» me ID e pajisjes (XXXX-XXXX-XXXX-XXXX).","getStarted.s5.title":"5. Licenca / trial","getStarted.s5.desc":"Për trial 7 ditë ose pagesë vjetore — paguani më poshtë ose na shkruani për çelës.","getStarted.s6.title":"6. Filloni punën","getStarted.s6.desc":"Ngjitni License Key te ekrani i aktivizimit — pastaj punoni normalisht.","getStarted.cta":"Merr linkun e Setup","getStarted.ctaHelp":"Ndihmë në WhatsApp","getStarted.note":"Setup NUK është download publik — ju dërgojmë link të mbrojtur me Email, SMS ose WhatsApp. Pako 4 (AI) vetëm me leje.","getStarted.version":"Versioni i fundit i Setup","getStarted.versionHint":"Kërkoni link zyrtar — mos shkarkoni nga burime të panjohura.","getStarted.setupLocked":"Për Setup zyrtar kërkoni link me Email, SMS ose WhatsApp.","setupModal.title":"Merr linkun zyrtar të Setup","setupModal.body":"Zgjidhni si ta merrni linkun e mbrojtur (skadon për 72 orë). Nuk ju duhet WhatsApp në kompjuter.","setupModal.email":"Email","setupModal.sms":"SMS","setupModal.whatsapp":"WhatsApp","setupModal.emailPlaceholder":"p.sh. ju@email.com","setupModal.phonePlaceholder":"Numër Kosove, p.sh. 048 707 880","setupModal.send":"Dërgo linkun","setupModal.sending":"Duke dërguar…","setupModal.close":"Mbyll","setupModal.pickChannel":"Zgjidhni Email, SMS ose WhatsApp.","setupModal.waHint":"Hapet WhatsApp (telefon ose Web) — ju dërgojmë linkun manualisht.","cta.startFree":"Fillo Falas","cta.choosePackage":"Zgjidh Pakon","cta.buyPackage":"Shkarko / Paguaj","cta.downloadSetup":"Shkarko Setup","cta.payStripe":"Vazhdo me pagesë","cta.contactAi":"Kontaktoni për AI","pay.title":"Pagesa","pay.subtitle":"Paguani me kartë ose me bankat vendore — zgjidhni mënyrën që ju përshtatet.","pay.stripe":"Kartë bankare","pay.stripeDesc":"Visa, Mastercard dhe pagesë online","pay.banks":"Banka vendore","pay.banksDesc":"Transfer bankar te llogaria e Revolution Invest","pay.soon":"Së shpejti","pay.active":"Aktiv","pay.ctaStripe":"Vazhdo me pagesë","pay.pickPlan":"Zgjidhni një pako (1–3) më lart, pastaj paguani këtu.","pay.bankHint":"Zgjidhni pakon (1–3) më lart, pastaj klikoni bankën — shfaqet numri i llogarisë për transfer.","pay.bank.teb":"TEB","pay.bank.raiffeisen":"Raiffeisen","pay.bank.nlb":"NLB","pay.bank.bkt":"BKT","pay.bank.procredit":"ProCredit","pay.bank.bpb":"BPB","bank.title":"Pagesë me transfer bankar","bank.intro":"Transferoni te llogaria më poshtë (Kosovë). Fatura e rregullt PDF (me vulë, nënshkrim dhe datë) dërgohet me email VETËM pasi të konfirmojmë pagesën në bankë — jo para.","bank.company":"Përfituesi","bank.bankName":"Banka","bank.account":"Nr. llogarisë","bank.currency":"Monedha","bank.nui":"NUI","bank.copy":"Kopjo nr. llogarisë","bank.copied":"U kopjua!","bank.submit":"Dërgo kërkesën (pas transferit)","bank.busy":"Duke dërguar…","bank.success":"Faleminderit! Kryeni transferin. Kur pagesa të shfaqet te ne, ju dërgojmë me email faturën PDF (vulë/datë) dhe çelësin e licencës. Pa konfirmim pagese nuk lëshohet faturë.","bank.error":"Kërkesa nuk u dërgua. Provoni përsëri ose WhatsApp.","checkout.title":"Pagesa me kartë — licenca (1 vit)","checkout.emri":"Emri juaj","checkout.biznesi":"Emri i biznesit","checkout.email":"Email","checkout.telefoni":"Telefoni","checkout.tipi":"Lloji i biznesit","checkout.pay":"Vazhdo me pagesë","checkout.cancel":"Anulo","checkout.busy":"Duke hapur pagesën…","checkout.error":"Pagesa nuk u hap. Provoni përsëri ose WhatsApp.","checkout.success":"Pagesa u krye! Shkarkoni Setup nga faqja dhe aktivizoni me çelësin që ju dërgojmë.","equip.title":"Sistemi i Avancuar i Pagesave dhe Menaxhimit të Shitjeve","equip.subtitle":"Pajisje POS moderne për dyqane, bare dhe gastronomi — performancë, qëndrueshmëri dhe dizajn ergonomik për punë pa ndërprerje.","equip.lead":"Sistemi ynë i integruar ofron një gamë të gjerë pajisjesh POS (Point of Sale), të dizajnuara posaçërisht për biznesin tuaj — nga dyqani i vogël me pakicë deri te pikat e mëdha të shërbimit.","equip.pointsTitle":"Pikat kryesore të produkteve tona","equip.p1.title":"Terminalë touchscreen","equip.p1.desc":"Ekrane me prekje të ndjeshme dhe procesorë të fuqishëm — transaksione të shpejta, pa vonesa në arkë.","equip.p2.title":"Printerë termikë","equip.p2.desc":"Printim me shpejtësi të lartë, pa bojë — fatura të qarta dhe të lexueshme çdo ditë.","equip.p3.title":"Skanerë barkodesh","equip.p3.desc":"Lexim i menjëhershëm 1D dhe 2D/QR — pa gabime manuale gjatë shitjes.","equip.p4.title":"Sirtarë parash","equip.p4.desc":"Ndërtim metalik i fortë, siguri dhe lidhje automatike me printerin ose terminalin.","equip.p5.title":"Lexues kartash (POS)","equip.p5.desc":"Pagesa elektronike të sigurta — kontaktuese, contactless dhe NFC.","equip.closing":"Optimizoni menaxhimin, rrisni shpejtësinë e shërbimit dhe sillni efikasitet maksimal në çdo transaksion me teknologjinë e gjeneratës së re.","equip.cta":"Kërko pajisje POS","equip.ctaSecondary":"Shiko pakot e softuerit","equip.wa":"Përshëndetje, dëshiroj informacion për pajisjet POS (terminal, printer, skaner, sirtar, lexues kartash).","checkout.tipi.restorant":"Restorant","checkout.tipi.kafene":"Kafene","checkout.tipi.dyqan":"Dyqan","cta.contactUs":"Na Kontaktoni","cta.sendRequest":"Dërgo kërkesën","expand.more":"Lexo më shumë","expand.less":"Më pak","hero.badge":"Provë falas 7 ditë","hero.title":"Kontrollo çdo Porosi. Çdo Tavolinë. Çdo Ditë.","hero.subtitle":"Nga kasa te kuzhina, nga kamarieri te pronari — plus stok, fatura, faqe publike për restorante & dyqane, porosi online dhe punë offline. Gjithçka në një platformë.","hero.cta.primary":"Fillo 7 ditë falas","hero.cta.secondary":"Shiko veçoritë →","trialModal.title":"Provë falas — 7 ditë","trialModal.body":"Shkarkoni Setup vetë nga faqja, instaloni, pastaj na shkruani për License Key (trial 7 ditë) ose paguani më poshtë.","trialModal.phoneLabel":"Telefon / WhatsApp","trialModal.phone":"+383 48707880","trialModal.download":"Shkarko Setup","trialModal.wa":"WhatsApp — kërko çelës trial","trialModal.close":"Mbyll","hero.stats.restaurants":"500+ Restorante","hero.stats.support":"24/7 Mbështetje","hero.stats.cloud":"Cloud & Offline","spotlight.title":"Çfarë përfshin programi","spotlight.subtitle":"Module profesionale që punojnë së bashku — nga operimi ditor te prezenca digjitale e biznesit tuaj.","spotlight.card1.category":"MENAXHIM","spotlight.card1.title":"Stoku, Faturat dhe Raportet","spotlight.card1.desc":"Inventar me përbërës dhe alarme stoku, fatura fiskale termike dhe raporte Z — kontroll i plotë mbi operacionet e restorantit.","spotlight.card1.link":"Lexo →","spotlight.card2.category":"PLATFORMË","spotlight.card2.title":"Restorant, Kafene & Dyqan — Faqe Publike për Çdo Lokal","spotlight.card2.desc":"Menu digjitale /r/ për restorante, vitrinë produktesh /s/ për dyqane, porosi online, rezervime tavolinash, offline me sync dhe panel pronari nga telefoni.","spotlight.card2.link":"Shiko pakot →","how.title":"Si funksionon sistemi","how.subtitle":"Katër module të lidhura — porosia shkon nga tavolina te kuzhina, pronari sheh gjithçka live, klienti gjen lokalin tuaj online.","how.pos.title":"POS Kasa","how.pos.desc":"Shitje të shpejta, tavolina, pagesa, fatura fiskale dhe printim termik — qendra e operimit të restorantit ose dyqanit tuaj.","how.waiter.title":"Kamarieri","how.waiter.desc":"Tablet ose telefon — merr porosi nga tavolina, punon edhe offline dhe i dërgon automatikisht në kuzhinë kur kthehet interneti.","how.kds.title":"KDS Kuzhina","how.kds.desc":"Ekran dixhital — porositë shfaqen live, stafi konfirmon gatishmërinë dhe servimi bëhet pa gabime.","how.owner.title":"Pronari","how.owner.desc":"Panel online — menu, stok, stafi, rezervime, faqja publike, raporte dhe QR — menaxhim i plotë nga kudo.","how.readManual":"Lexo në manual →","packages.title":"Pakot — çfarë përmban secila","packages.subtitle":"Zgjidhni vetëm një pako. Shihni çfarë përfshin; për çmime dhe oferta kontaktoni telefon ose email. Pagesa me kartë kur jeni gati.","packages.badge":"1 pako","packages.priceHint":"Për çmime / oferta: WhatsApp ose email — nuk shfaqen publike.","packages.oneOnly":"Mund të zgjidhni vetëm një pako. Për të ndryshuar, klikoni përsëri pakon e zgjedhur.","packages.p1.name":"Pako 1 — Standard","packages.p1.tagline":"POS + KDS + kamarier + kiosk + cloud","packages.p1.summary":"Manual — Pako 1: kasa POS, ekran kuzhine (KDS), kamarier nga telefoni, kiosk QR, sync cloud dhe panel pronari. Pa porosi online. Pa AI.","packages.p1.incl":"Përmban:","packages.p1.f1":"Kasa POS — tavolina, pagesa, printer","packages.p1.f2":"KDS — porosi live në kuzhinë","packages.p1.f3":"Kamarier — tablet / telefon","packages.p1.f4":"Kiosk QR nga tavolina","packages.p1.f5":"Cloud sync & panel pronari","packages.p1.f6":"Faqe publike menu (/r/)","packages.p2.name":"Pako 2 — Pro","packages.p2.tagline":"Gjithçka nga Standard + porosi online","packages.p2.summary":"Manual — Pako 2: e gjithë Pako 1, plus takeaway & delivery nga faqja. Ideal kur klienti porosit edhe jashtë lokalit. Pa AI.","packages.p2.incl":"Përmban (plus Pako 1):","packages.p2.f1":"Porosi online — takeaway & delivery","packages.p2.f2":"Faqe me porosi direkte","packages.p2.f3":"Sync porosive me POS & kuzhinë","packages.p2.f4":"Prano / refuzo porosi","packages.p2.f5":"Raporte nga të gjitha kanalet","packages.p2.f6":"Mbështetje prioritet","packages.p3.name":"Pako 3 — Full","packages.p3.tagline":"I plotë pa AI","packages.p3.summary":"Manual — Pako 3: POS, KDS, kamarier, kiosk, cloud, porosi online — paketa e plotë operative. Pa module AI (AI vetëm Pako 4 me leje).","packages.p3.incl":"Përmban (plus Pako 2):","packages.p3.f1":"POS + KDS + kamarier + kiosk","packages.p3.f2":"Porosi online (takeaway & delivery)","packages.p3.f3":"Cloud sync & backup","packages.p3.f4":"Kontabilisti ATK (libra / TVSH)","packages.p3.f5":"Panel i plotë (menu, stok, staf)","packages.p3.f6":"Pa AI — AI vetëm me leje (Pako 4)","packages.p4.name":"Pako 4 — AI","packages.p4.tagline":"Full + AI — vetëm me leje","packages.p4.summary":"Manual — Pako 4: gjithçka nga Full + AI. Nuk aktivizohet online vetë. Vetëm pasi na kontaktoni dhe e lejojmë manualisht.","packages.p4.incl":"Përmban (plus Pako 3):","packages.p4.f1":"Skanim AI — fatura / menu","packages.p4.f2":"Asistent AI për pronarin","packages.p4.f3":"Parashikim stoku & raporte AI","packages.p4.f4":"Kontroll tokenësh nga admini","packages.p4.f5":"Aktivizim VETËM me lejen tonë","packages.p4.f6":"Kontaktoni për AI — jo blerje automatike","packages.clickHint":"Zgjidhni një pako (vetëm një). Pastaj vazhdoni me pagesë ose kontakt.","packages.includes":"Çfarë përmban kjo pako:","packages.selected":"Zgjedhur — vetëm kjo pako","contact.title":"Filloni sot — trial 7 ditë","contact.subtitle":"Na kontaktoni në WhatsApp për trial, instalim Setup.exe dhe zgjedhjen e pakos (Standard, Pro, Full ose AI).","contact.direct":"Kontakt i drejtpërdrejtë","contact.email":"revolutioninvest05@gmail.com","contact.sendMessage":"Dërgo mesazh","form.name":"Emri","form.phone":"Telefoni","form.message":"Mesazhi","form.namePlaceholder":"Emri i biznesit","form.messagePlaceholder":"P.sh. Restorant me 15 tavolina ose dyqan me 200 produkte…","form.error":"Plotësoni të gjitha fushat.","form.success":"Faleminderit! Po ju hapim WhatsApp për të dërguar kërkesën.","footer.tagline":"Sistemi i plotë POS për restorante, kafene, bare dhe dyqane — porosi, kuzhinë, stok, faqe publike dhe menaxhim nga një vend.","footer.note":"Zhvilluar dhe mirëmbajtur nga ekipi ynë në Kosovë dhe rajon.","footer.col.platform":"Platforma","footer.col.support":"Ndihmë & kontakt","footer.link.howItWorks":"Si funksionon","footer.link.packages":"Pakot & modulet","footer.link.blog":"Artikuj & këshilla","footer.link.manual":"Manuali i përdorimit","footer.link.contact":"Na kontaktoni","footer.link.trial":"Fillo provën falas","footer.legal.privacy":"Privatësia e të dhënave","footer.legal.terms":"Kushtet e shërbimit","footer.legal.notice":"Revolution Invest POS ofrohet me licencë të rregullt. Të dhënat e biznesit tuaj ruhen në mënyrë të sigurt sipas politikës sonë të privatësisë.","footer.rights":"Revolution Invest. Të gjitha të drejtat e rezervuara.","wa.trial":"Përshëndetje, dëshiroj të provoj Revolution Invest POS.","wa.custom":"Përshëndetje, dëshiroj të diskutoj për zgjidhje të personalizuara.","wa.formIntro":"Përshëndetje, jam {name} ({phone}).","wa.formSuffix":"Dëshiroj Revolution Invest POS — trial 7 ditë.","legal.backHome":"← Kthehu në ballina","articles.heading":"Artikujt e fundit"},en:{"meta.title":"Revolution Invest POS — POS for Restaurants, Cafés & Shops","meta.description":"Revolution Invest POS — full platform for restaurants, cafés and retail. POS, kitchen, waiter, public pages /r/ & /s/, online orders and offline sync.","brand.subtitle":"Restaurant · Café · Shop","nav.home":"Home","nav.howItWorks":"How it works","nav.getStarted":"How to install","nav.packages":"Pricing","nav.equipment":"Hardware","nav.blog":"Blog","nav.manual":"Manual","nav.contact":"Contact","nav.openMenu":"Open menu","getStarted.title":"How to install the program — step by step","getStarted.subtitle":"Get the official Setup link by Email, SMS or WhatsApp — then install and activate.","getStarted.s1.title":"1. Choose a plan","getStarted.s1.desc":"See Packages (Standard, Pro, Full or AI) and pick what you need.","getStarted.s2.title":"2. Download Setup","getStarted.s2.desc":"Request an official link by Email, SMS or WhatsApp — open it on your PC and download the .exe.","getStarted.s3.title":"3. Install the app","getStarted.s3.desc":"Open Setup.exe and follow the Windows installer.","getStarted.s4.title":"4. Open activation","getStarted.s4.desc":"At the end «Activate KAFENE» opens with your device ID (XXXX-XXXX-XXXX-XXXX).","getStarted.s5.title":"5. License / trial","getStarted.s5.desc":"For a 7-day trial or annual license — pay below or message us for a key.","getStarted.s6.title":"6. Start working","getStarted.s6.desc":"Paste the License Key on the activation screen — then work normally.","getStarted.cta":"Get Setup link","getStarted.ctaHelp":"Help on WhatsApp","getStarted.note":"Setup is NOT a public download — we send a protected link by Email, SMS or WhatsApp. Plan 4 (AI) needs approval.","getStarted.version":"Latest Setup version","getStarted.versionHint":"Ask for an official link — do not download from unknown sources.","getStarted.setupLocked":"For official Setup request a link by Email, SMS or WhatsApp.","setupModal.title":"Get the official Setup link","setupModal.body":"Choose how to receive the protected link (expires in 72 hours). WhatsApp on the PC is not required.","setupModal.email":"Email","setupModal.sms":"SMS","setupModal.whatsapp":"WhatsApp","setupModal.emailPlaceholder":"e.g. you@email.com","setupModal.phonePlaceholder":"Kosovo number, e.g. 048 707 880","setupModal.send":"Send link","setupModal.sending":"Sending…","setupModal.close":"Close","setupModal.pickChannel":"Choose Email, SMS or WhatsApp.","setupModal.waHint":"Opens WhatsApp (phone or Web) — we send the link manually.","cta.startFree":"Start Free","cta.choosePackage":"Choose Plan","cta.buyPackage":"Download / Pay","cta.downloadSetup":"Download Setup","cta.payStripe":"Continue to payment","cta.contactAi":"Contact for AI","pay.title":"Payment","pay.subtitle":"Pay by card or via local banks — choose what works for you.","pay.stripe":"Bank card","pay.stripeDesc":"Visa, Mastercard and online checkout","pay.banks":"Local banks","pay.banksDesc":"Bank transfer to Revolution Invest","pay.soon":"Soon","pay.active":"Active","pay.ctaStripe":"Continue to payment","pay.pickPlan":"Select a plan (1–3) above, then pay here.","pay.bankHint":"Select a plan (1–3) above, then click a bank — account number for transfer will appear.","pay.bank.teb":"TEB","pay.bank.raiffeisen":"Raiffeisen","pay.bank.nlb":"NLB","pay.bank.bkt":"BKT","pay.bank.procredit":"ProCredit","pay.bank.bpb":"BPB","bank.title":"Pay by bank transfer","bank.intro":"Transfer to the account below (Kosovo). The regular PDF invoice (stamp, signature, date) is emailed ONLY after we confirm the bank payment — not before.","bank.company":"Beneficiary","bank.bankName":"Bank","bank.account":"Account number","bank.currency":"Currency","bank.nui":"NUI","bank.copy":"Copy account number","bank.copied":"Copied!","bank.submit":"Submit request (after transfer)","bank.busy":"Sending…","bank.success":"Thank you! Complete the transfer. When the payment appears on our side we email the PDF invoice (stamp/date) and license key. No invoice without payment confirmation.","bank.error":"Request failed. Try again or WhatsApp.","checkout.title":"Card payment — license (1 year)","checkout.emri":"Your name","checkout.biznesi":"Business name","checkout.email":"Email","checkout.telefoni":"Phone","checkout.tipi":"Business type","checkout.pay":"Continue to payment","checkout.cancel":"Cancel","checkout.busy":"Opening payment…","checkout.error":"Checkout failed. Try again or WhatsApp.","checkout.success":"Payment done! Download Setup from the site and activate with the key we send.","equip.title":"Advanced Payment & Sales Management System","equip.subtitle":"Modern POS hardware for shops, bars and hospitality — performance, durability and ergonomic design for uninterrupted work.","equip.lead":"Our integrated system offers a wide range of POS devices designed for your business — from small retail shops to large service and restaurant points.","equip.pointsTitle":"Key product highlights","equip.p1.title":"High-performance touchscreen terminals","equip.p1.desc":"Responsive touchscreens and powerful processors — fast, lag-free checkout.","equip.p2.title":"Thermal receipt printers","equip.p2.desc":"High-speed, ink-free printing — clear, readable receipts every day.","equip.p3.title":"Precision barcode scanners","equip.p3.desc":"Instant 1D and 2D/QR reading — fewer manual errors at sale.","equip.p4.title":"Professional cash drawers","equip.p4.desc":"Strong metal build, security mechanisms, automatic link to printer or terminal.","equip.p5.title":"Card readers (POS terminal)","equip.p5.desc":"Secure electronic payments — contact, contactless and NFC.","equip.closing":"Optimize management, speed up service and bring maximum efficiency to every transaction with next-generation technology.","equip.cta":"Ask about POS hardware","equip.ctaSecondary":"See software packages","equip.wa":"Hello, I would like information about POS hardware (terminal, printer, scanner, cash drawer, card reader).","checkout.tipi.restorant":"Restaurant","checkout.tipi.kafene":"Café","checkout.tipi.dyqan":"Shop","cta.contactUs":"Contact Us","cta.sendRequest":"Send request","expand.more":"Read more","expand.less":"Show less","hero.badge":"7-day free trial","hero.title":"Control Every Order. Every Table. Every Day.","hero.subtitle":"From register to kitchen, waiter to owner — plus stock, invoices, public pages for restaurants & shops, online orders and offline work. All in one platform.","hero.cta.primary":"Start 7-day free trial","hero.cta.secondary":"See features →","trialModal.title":"Free trial — 7 days","trialModal.body":"Download Setup yourself, install, then message us for a License Key (7-day trial) or pay below.","trialModal.phoneLabel":"Phone / WhatsApp","trialModal.phone":"+383 48707880","trialModal.download":"Download Setup","trialModal.wa":"WhatsApp — request trial key","trialModal.close":"Close","hero.stats.restaurants":"500+ Restaurants","hero.stats.support":"24/7 Support","hero.stats.cloud":"Cloud & Offline","spotlight.title":"What's inside the platform","spotlight.subtitle":"Professional modules that work together — from daily operations to your business's digital presence.","spotlight.card1.category":"MANAGEMENT","spotlight.card1.title":"Inventory, Invoices & Reports","spotlight.card1.desc":"Ingredient inventory with stock alerts, fiscal receipts and Z-reports — full control over restaurant operations.","spotlight.card1.link":"Read →","spotlight.card2.category":"PLATFORM","spotlight.card2.title":"Restaurant, Café & Shop — A Public Page for Every Venue","spotlight.card2.desc":"Digital menu /r/ for restaurants, product storefront /s/ for shops, online orders, table reservations, offline sync and owner panel from your phone.","spotlight.card2.link":"View plans →","how.title":"How the system works","how.subtitle":"Four connected modules — orders flow from table to kitchen, the owner sees everything live, guests find you online.","how.pos.title":"POS Register","how.pos.desc":"Take orders, issue fiscal invoices, and manage tables — the hub of your restaurant operations.","how.waiter.title":"Waiter","how.waiter.desc":"Tablet or phone — take orders directly from the table and send them automatically to the kitchen.","how.kds.title":"Kitchen KDS","how.kds.desc":"Digital screen — see orders in real time and confirm when a dish is ready to serve.","how.owner.title":"Owner","how.owner.desc":"Online panel — view reports, manage menu and staff from anywhere, even your phone.","how.readManual":"Read in manual →","packages.title":"Plans — what's in each package","packages.subtitle":"Choose only one plan. See what's included; for pricing contact phone or email. Card payment when ready.","packages.badge":"1 plan","packages.priceHint":"For prices / offers: WhatsApp or email — not shown publicly.","packages.oneOnly":"You can select only one plan. To change, click the selected plan again.","packages.p1.name":"Plan 1 — Standard","packages.p1.tagline":"POS + KDS + waiter + kiosk + cloud","packages.p1.summary":"Guide — Plan 1: POS register, kitchen display, waiter app, QR kiosk, cloud sync and owner panel. No online orders. No AI.","packages.p1.incl":"Includes:","packages.p1.f1":"POS register — tables, payments, printer","packages.p1.f2":"KDS — live kitchen orders","packages.p1.f3":"Waiter — tablet / phone","packages.p1.f4":"QR kiosk from the table","packages.p1.f5":"Cloud sync & owner panel","packages.p1.f6":"Public menu page (/r/)","packages.p2.name":"Plan 2 — Pro","packages.p2.tagline":"Everything in Standard + online orders","packages.p2.summary":"Guide — Plan 2: all of Plan 1, plus takeaway & delivery from the public page. No AI.","packages.p2.incl":"Includes (plus Plan 1):","packages.p2.f1":"Online orders — takeaway & delivery","packages.p2.f2":"Public page with direct ordering","packages.p2.f3":"Order sync to POS & kitchen","packages.p2.f4":"Accept / refuse orders","packages.p2.f5":"Reports across all channels","packages.p2.f6":"Priority support","packages.p3.name":"Plan 3 — Full","packages.p3.tagline":"Complete without AI","packages.p3.summary":"Guide — Plan 3: POS, KDS, waiter, kiosk, cloud, online orders — full ops package. AI only in Plan 4 with our approval.","packages.p3.incl":"Includes (plus Plan 2):","packages.p3.f1":"POS + KDS + waiter + kiosk","packages.p3.f2":"Online orders (takeaway & delivery)","packages.p3.f3":"Cloud sync & backup","packages.p3.f4":"ATK accountant (books / VAT)","packages.p3.f5":"Full panel (menu, stock, staff)","packages.p3.f6":"No AI — AI only with approval (Plan 4)","packages.p4.name":"Plan 4 — AI","packages.p4.tagline":"Full + AI — approval required","packages.p4.summary":"Guide — Plan 4: everything in Full + AI. Not self-activated online. Only after you contact us and we enable it.","packages.p4.incl":"Includes (plus Plan 3):","packages.p4.f1":"AI scan — invoices / menu","packages.p4.f2":"AI assistant for owners","packages.p4.f3":"Stock forecast & AI reports","packages.p4.f4":"Token control by admin","packages.p4.f5":"Activation ONLY with our approval","packages.p4.f6":"Contact for AI — no automatic purchase","packages.clickHint":"Select one plan only. Then pay by card or contact us.","packages.includes":"What's in this plan:","packages.selected":"Selected — this plan only","contact.title":"Start today — 7-day trial","contact.subtitle":"Contact us on WhatsApp for trial, Setup.exe install, and choosing Standard, Pro, Full or AI.","contact.direct":"Direct contact","contact.email":"revolutioninvest05@gmail.com","contact.sendMessage":"Send a message","form.name":"Name","form.phone":"Phone","form.message":"Message","form.namePlaceholder":"Business name","form.messagePlaceholder":"E.g. Restaurant with 15 tables in Pristina…","form.error":"Please fill in all fields.","form.success":"Thank you! Opening WhatsApp so you can send your request.","footer.tagline":"The complete POS system for restaurants, cafés, and bars — orders, kitchen, reports, and management from one place.","footer.note":"Developed and maintained by our team in Kosovo and the region.","footer.col.platform":"Platform","footer.col.support":"Help & contact","footer.link.howItWorks":"How it works","footer.link.packages":"Plans & modules","footer.link.blog":"Articles & tips","footer.link.manual":"User manual","footer.link.contact":"Contact us","footer.link.trial":"Start free trial","footer.legal.privacy":"Data privacy","footer.legal.terms":"Terms of service","footer.legal.notice":"Revolution Invest POS is provided under a standard license. Your business data is stored securely in line with our privacy policy.","footer.rights":"Revolution Invest. All rights reserved.","wa.trial":"Hello, I would like to try Revolution Invest POS.","wa.custom":"Hello, I would like to discuss a tailored solution.","wa.formIntro":"Hello, I'm {name} ({phone}).","wa.formSuffix":"I want Revolution Invest POS — 1 month free.","legal.backHome":"← Back to home","articles.heading":"Latest articles"}},X="revolution-pos-lang";let w=localStorage.getItem(X)||"sq";function j(){return w}function re(t){t!=="sq"&&t!=="en"||(w=t,localStorage.setItem(X,w),document.documentElement.lang=w==="en"?"en":"sq")}function e(t){var a,i;return((a=U[w])==null?void 0:a[t])??((i=M[w])==null?void 0:i[t])??U.sq[t]??M.sq[t]??t}document.documentElement.lang=w==="en"?"en":"sq";function $(){return"/"}function se(){return"/blog"}function le(t){return`${se()}/${t}`.replace(/\/+/g,"/")}function P(t){return`/${t.replace(/^\//,"")}`}function N(t){return S()==="/"?`#${t}`:`/#${t}`}function E(t,a,i,n){const o=S()==="/";return`<a href="${N(t)}"${o?"":" data-navigate"} class="${i===n?"active":""}">${a}</a>`}function pe(t,a){return`<a href="#pajisjet" data-equip-modal class="${a==="equipment"?"active":""}">${t}</a>`}function F({activeNav:t="home"}={}){const a=j(),i=[{id:"home",label:e("nav.home"),section:"ballina"},{id:"get-started",label:e("nav.getStarted"),section:"si-ta-ngarkoni"},{id:"how-it-works",label:e("nav.howItWorks"),section:"si-funksionon"},{id:"packages",label:e("nav.packages"),section:"pakot"},{id:"equipment",label:e("nav.equipment"),equipModal:!0},{id:"blog",label:e("nav.blog"),section:"artikuj"}],n=o=>o.equipModal?pe(o.label,t):E(o.section,o.label,t,o.id);return`
    <header class="site-header">
      <div class="container header-inner">
        ...
        <div class="header-actions">
          ...
          <a class="btn btn-primary header-cta-desktop" href="${N("kontakt")}">${e("cta.startFree")}</a>
      ...
      <nav class="nav-mobile" id="nav-mobile" aria-label="${e("navLabel")}">
        ...
        <a href="/website/manual.html">${e("nav.manual")}</a>
        ${E("kontakt",e("nav.contact"),t,"contact")}
        <a class="btn btn-primary" href="${N("kontakt")}">${e("cta.startFree")}</a>
      </nav>
    </header>
  `}function q(t,a){const i=S()==="/";return`<li><a href="${i?`#${t}`:`/#${t}`}"${i?"":" data-navigate"}>${a}</a></li>`}function W(){const a=S()==="/"?"":" data-navigate";return`
  ...
  `}function D(){const t=document.getElementById("footer-whatsapp");if(!t)return;async function a(){try{const i=await fetch("/api/public/config"),n=await i.json();if(!i.ok||!n.ok)return;const o=n.support_phone||"+383 48707880",s=n.support_phone_digits||"38348707880";t.textContent=`WhatsApp — ${o}`,t.href=`https://wa.me/${s}?text=${encodeURIComponent(e("wa.trial"))}`}catch{t.textContent="WhatsApp",t.href=`https://wa.me/38348707880?text=${encodeURIComponent(e("wa.trial"))}`}}a()}function B(){return`<button id="back-to-top" class="back-to-top" type="button" aria-label="${e("backToTop")}">↑</button>`}function H(){const t=document.querySelector("#back-to-top");if(!t)return;const a=()=>{t.classList.toggle("visible",window.scrollY>400)};window.removeEventListener("scroll",a),window.addEventListener("scroll",a),a(),t.onclick=()=>{window.scrollTo({top:0,behavior:"smooth"})}}function _(){document.querySelectorAll(".lang-switch button[data-lang]").forEach(t=>{t.onclick=()=>{const a=t.dataset.lang;a!==j()&&(re(a),I())}})}function V(){const t=document.getElementById("menu-toggle"),a=document.getElementById("nav-mobile");t==null||t.addEventListener("click",()=>{const i=a.classList.toggle("open");t.setAttribute("aria-expanded",i?"true":"false")}),a==null||a.querySelectorAll("a").forEach(i=>{i.addEventListener("click",()=>a.classList.remove("open"))})}const ue={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},ce={...ue,...he,...de},me={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},fe={...me,...ge,...ke},Y=[{slug:"stoku-faturat-dhe-skanimi-me-ai",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku, Faturat dhe Skanimi me AI: Kontroll më i Lehtë për Restorantin",date:"06 maj 2026"},en:{category:"MANAGEMENT",title:"Inventory, Invoices & AI Scanning: Easier Control for Your Restaurant",date:"06 May 2026"}},{slug:"aplikacion-offline-me-sync",variant:"mobile",sq:{category:"POS & TEKNOLOGJI",title:"Aplikacion Offline me Sync për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Offline App with Sync for Restaurants",date:"06 May 2026"}},{slug:"program-pos-falas",variant:"pos",sq:{category:"POS & TEKNOLOGJI",title:"Program POS Falas për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Free POS Software for Restaurants",date:"06 May 2026"}},{slug:"5-arsye-pos",variant:"analytics",sq:{category:"MENAXHIM",title:"5 Arsye pse çdo restorant ka nevojë për POS",date:"05 maj 2026"},en:{category:"MANAGEMENT",title:"5 Reasons Every Restaurant Needs a POS System",date:"05 May 2026"}},{slug:"porosite-klienteve",variant:"mobile",sq:{category:"FUNKSIONALITETE",title:"Porositë e Klientëve: Klientët porosisin direkt nga telefoni",date:"04 maj 2026"},en:{category:"FEATURES",title:"Customer Orders: Guests Order Directly from Their Phone",date:"04 May 2026"}},{slug:"meny-digjitale-qr",variant:"qr",sq:{category:"TEKNOLOGJI",title:"Meny Digjitale me QR Code",date:"03 maj 2026"},en:{category:"TECHNOLOGY",title:"Digital Menu with QR Code",date:"03 May 2026"}},{slug:"skanoni-menyne-me-ai",variant:"scan",sq:{category:"TEKNOLOGJI",title:"Skanoni Menunë me AI: Shtoni 50 Produkte në 2 Minuta",date:"28 mars 2026"},en:{category:"TECHNOLOGY",title:"Scan Your Menu with AI: Add 50 Products in 2 Minutes",date:"28 March 2026"}},{slug:"stoku-menaxhimi-inventarit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku: Si të Menaxhoni Inventarin e Restorantit pa Humbje",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Inventory: How to Manage Restaurant Stock Without Losses",date:"28 March 2026"}},{slug:"zbritjet-ne-restorante",variant:"pos",sq:{category:"MENAXHIM",title:"Zbritjet në Restorante: Si të Rrisni Shitjet me Oferta të Zgjuara",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Discounts: Grow Sales with Smart Offers",date:"28 March 2026"}},{slug:"analitika-ne-restorante",variant:"analytics",sq:{category:"ANALITIKË",title:"Analitika në Restorante: Nga të Dhënat te Vendime më të Mira",date:"27 mars 2026"},en:{category:"ANALYTICS",title:"Restaurant Analytics: From Data to Better Decisions",date:"27 March 2026"}},{slug:"bashko-tavolina",variant:"tables",sq:{category:"VEÇORI",title:"Bashko Tavolina: Si të Kombinosh Porositë pa Ndërprerje",date:"27 mars 2026"},en:{category:"FEATURES",title:"Merge Tables: Combine Orders Without Disruption",date:"27 March 2026"}},{slug:"identifikim-stafi",variant:"login",sq:{category:"VEÇORI",title:"Identifikim Stafi: PIN, RFID apo Fjalëkalim — Cila Metodë për Çfarë?",date:"27 mars 2026"},en:{category:"FEATURES",title:"Staff Login: PIN, RFID or Password — Which Method for What?",date:"27 March 2026"}},{slug:"raportet-e-restorantit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Raportet e Restorantit: Si të Kuptosh Biznesin Tënd me Numra",date:"27 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Reports: Understand Your Business by the Numbers",date:"27 March 2026"}}];function ve(t){return t==="en"?fe:ce}function Z(t,a){const i=t[a]??t.sq,n=ve(a)[t.slug];return n?{slug:t.slug,variant:t.variant,category:i.category,title:i.title,date:i.date,content:n}:null}function ye(t,a=j()){const i=Y.find(n=>n.slug===t);return i?Z(i,a):null}function be(t=j()){return Y.map(a=>Z(a,t)).filter(Boolean)}const je=P("images/articles/program-pos-falas.jpg");function we(t){return P(`images/articles/${t}.jpg`)}function G(t,{alt:a="",loading:i="lazy",className:n="article-photo"}={}){const o=a.replace(/"/g,"&quot;");return`<img src="${we(t)}" alt="${o}" class="${n}" loading="${i}" onerror="this.onerror=null;this.src='${je}';" />`}const Se=P("images/hero.jpg"),Pe=["p1","p2","p3","p4"],J={p1:["incl","f1","f2","f3","f4","f5","f6"],p2:["incl","f1","f2","f3","f4","f5","f6"],p3:["incl","f1","f2","f3","f4","f5","f6"],p4:["incl","f1","f2","f3","f4","f5","f6"]},qe={p1:["incl","f1","f2","f3","f4"],p2:["incl","f1","f2","f3","f4"],p3:["incl","f1","f2","f3","f4"],p4:["incl","f1","f2","f3","f4"]};function ee(t,{keys:a}={}){const i=`packages.${t}`;return(a??J[t]??[]).map(o=>e(`${i}.${o}`)).filter(Boolean).map(o=>`<li>${o}</li>`).join("")}function z(t){const a=`packages.${t}`,i=e(`${a}.tagline`),n=e(`${a}.name`);return`
    ...
    >
      ...
      <div class="package-card-body">
        ...
        <ul class="package-list">${ee(t,{keys:qe[t]})}</ul>
  ...
  `}function O(t,a,i,n){const o=e(a);return`
    <article class="how-card">
      <div class="how-card-photo">
        <img src="${P(t)}" alt="${o}" loading="lazy" />
      </div>
  ...
  `}function Re(t){return`
    ...
    </div>`}function Ae({variant:t,categoryKey:a,titleKey:i,descKey:n,linkKey:o,href:s,imageSlug:r="",hidePhoto:l=!1}){const u=r?`<div class="spotlight-photo-fallback">${G(r,{className:"spotlight-img"})}</div>`:"",h=l?"":`
      <div class="spotlight-photo">
        ${Re()}
        ${u}
      </div>`;return`
    <a class="spotlight-card spotlight-card-${t}${l?" spotlight-card--no-photo":""}" href="${s}" data-navigate>
      ${h}
      <div class="spotlight-body">
        <div class="spotlight-category">${e(a)}</div>
        <h3 class="spotlight-title">${e(i)}</h3>
        <p class="spotlight-desc">${e(n)}</p>
        <span class="spotlight-link">${e(o)}</span>
      </div>
    </a>
  `}function ze(){const t=window.matchMedia("(max-width: 640px)");document.querySelectorAll(".how-card").forEach(a=>{const i=a.querySelector(".how-card-desc-wrap"),n=a.querySelector(".how-card-desc");if(!i||!n)return;let o=a.querySelector(".card-toggle[data-how-toggle]");o||(o=document.createElement("button"),o.type="button",o.className="card-toggle",o.dataset.howToggle="1",i.insertAdjacentElement("afterend",o));const s=()=>{const r=i.classList.contains("is-expanded"),l=t.matches&&(r||n.textContent.trim().length>85);o.hidden=!l,o.setAttribute("aria-expanded",r?"true":"false"),o.textContent=e(r?"expand.less":"expand.more"),t.matches||i.classList.remove("is-expanded")};o.addEventListener("click",()=>{i.classList.toggle("is-expanded"),s()}),s(),t.addEventListener("change",s),window.addEventListener("resize",s,{passive:!0})}),document.querySelectorAll(".package-card[data-package]").forEach(a=>{const i=a.querySelector(".package-list");if(!i)return;i.classList.add("package-list--foldable");let n=a.querySelector(".card-toggle[data-package-toggle]");n||(n=document.createElement("button"),n.type="button",n.className="card-toggle",n.dataset.packageToggle="1",i.insertAdjacentElement("afterend",n));const o=()=>{const s=i.querySelectorAll("li"),r=i.classList.contains("is-expanded"),l=t.matches&&s.length>3;n.hidden=!l,n.setAttribute("aria-expanded",r?"true":"false"),n.textContent=e(r?"expand.less":"expand.more"),t.matches||i.classList.remove("is-expanded")};n.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),i.classList.toggle("is-expanded"),o()}),o(),t.addEventListener("change",o)})}function Oe(){fetch("/api/public/config").then(n=>n.json()).then(n=>{n!=null&&n.ok&&n.stripe_enabled&&(window.__stripeEnabled=!0)}).catch(()=>{});const t=new URLSearchParams(window.location.hash.split("?")[1]||""),a=t.get("payment"),i=t.get("session_id");if(a==="success"){const n=document.querySelector(".get-started-note");n&&(n.textContent=e("checkout.success"),n.style.color="#15803d"),i&&i.startsWith("cs_")&&fetch("/api/payments/confirm-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({session_id:i})}).catch(()=>{})}}function Ie(t="38348707880",a=""){const i=a?` (pako ${a})`:"",n=j()==="en"?`Hello, I need the official protected Setup link${i} and a license / trial key.`:`Përshëndetje, më duhet linku zyrtar i mbrojtur për Setup${i} dhe çelës trial / licencë.`;return`https://wa.me/${t}?text=${encodeURIComponent(n)}`}function C(){return encodeURIComponent(j()==="en"?"Hello, I need the official protected Setup download link and a trial / license key.":"Përshëndetje, më duhet linku zyrtar i mbrojtur për Setup dhe çelës trial / licencë.")}async function L(t=""){var y;const a=document.getElementById("setup-link-modal");a&&a.remove();let i="38348707880",n=!0,o=!0;try{const p=await fetch("/api/public/config"),c=await p.json();p.ok&&c.ok&&(c.support_phone_digits&&(i=c.support_phone_digits),n=c.setup_via_email===!0,o=c.setup_via_sms===!0)}catch{}const s=`https://wa.me/${i}?text=${C()}`,r=document.createElement("div");r.id="setup-link-modal",r.className="checkout-modal",r.innerHTML=`
    <div class="checkout-modal-card checkout-modal-card-wide" role="dialog" aria-modal="true" aria-labelledby="setup-link-title">
      <h3 id="setup-link-title">${e("setupModal.title")}</h3>
      <p class="trial-modal-body">${e("setupModal.body")}</p>
      <div class="setup-channel-tabs" role="tablist">
        <button type="button" class="setup-channel-btn is-active" data-setup-ch="email"${n?"":" disabled"}>${e("setupModal.email")}</button>
        <button type="button" class="setup-channel-btn" data-setup-ch="sms"${o?"":" disabled"}>${e("setupModal.sms")}</button>
        <button type="button" class="setup-channel-btn" data-setup-ch="whatsapp">${e("setupModal.whatsapp")}</button>
      </div>
      <div id="setup-ch-email" class="setup-ch-panel">
        <label for="setup-email-input">${e("setupModal.email")}</label>
        <input type="email" id="setup-email-input" autocomplete="email" placeholder="${e("setupModal.emailPlaceholder")}" />
      </div>
      <div id="setup-ch-sms" class="setup-ch-panel" hidden>
        <label for="setup-phone-input">${e("setupModal.sms")}</label>
        <input type="tel" id="setup-phone-input" autocomplete="tel" placeholder="${e("setupModal.phonePlaceholder")}" />
      </div>
      <div id="setup-ch-whatsapp" class="setup-ch-panel" hidden>
        <p class="trial-modal-body">${e("setupModal.waHint")}</p>
      </div>
      <p class="setup-link-msg" id="setup-link-msg" hidden></p>
      <div class="checkout-actions">
        <button type="button" class="btn btn-primary" id="setup-link-send">${e("setupModal.send")}</button>
        <a class="btn btn-ghost" id="setup-link-wa" href="${s}" target="_blank" rel="noopener noreferrer" hidden>${e("setupModal.whatsapp")}</a>
        <button type="button" class="btn btn-ghost" id="setup-link-close">${e("setupModal.close")}</button>
      </div>
    </div>`,document.body.appendChild(r);let l=n?"email":o?"sms":"whatsapp";const u={email:r.querySelector("#setup-ch-email"),sms:r.querySelector("#setup-ch-sms"),whatsapp:r.querySelector("#setup-ch-whatsapp")},h=r.querySelector("#setup-link-send"),g=r.querySelector("#setup-link-wa"),k=r.querySelector("#setup-link-msg");function d(p){l=p,r.querySelectorAll(".setup-channel-btn").forEach(c=>{c.classList.toggle("is-active",c.dataset.setupCh===p)}),Object.entries(u).forEach(([c,f])=>{f&&(f.hidden=c!==p)}),h&&(h.hidden=p==="whatsapp"),g&&(g.hidden=p!=="whatsapp"),k&&(k.hidden=!0,k.textContent="")}r.querySelectorAll("[data-setup-ch]").forEach(p=>{p.addEventListener("click",()=>{p.disabled||d(p.dataset.setupCh)})}),d(l);const b=()=>r.remove();(y=r.querySelector("#setup-link-close"))==null||y.addEventListener("click",b),r.addEventListener("click",p=>{p.target===r&&b()}),h==null||h.addEventListener("click",async()=>{var p,c;if(l!=="whatsapp"){k.hidden=!1,k.className="setup-link-msg",k.textContent=e("setupModal.sending"),h.disabled=!0;try{const f={channel:l,plan:t||sessionStorage.getItem("selectedPackage")||"",lang:j()};l==="email"&&(f.email=((p=r.querySelector("#setup-email-input"))==null?void 0:p.value)||""),l==="sms"&&(f.phone=((c=r.querySelector("#setup-phone-input"))==null?void 0:c.value)||"");const m=await fetch("/api/public/setup-link-request",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(f)}),v=await m.json().catch(()=>({}));if(!m.ok||!v.ok){k.className="setup-link-msg err",k.textContent=v.gabim||e("setupModal.pickChannel");return}k.className="setup-link-msg ok",k.textContent=v.message||e("setupModal.send")}catch{k.className="setup-link-msg err",k.textContent=j()==="en"?"Network error. Try again.":"Gabim rrjeti. Provoni përsëri."}finally{h.disabled=!1}}})}function Me(){var i,n;const t=document.getElementById("get-started-wa"),a=document.getElementById("setup-version-label");(i=document.getElementById("get-started-download"))==null||i.addEventListener("click",o=>{o.preventDefault(),L()}),(n=document.getElementById("package-detail-download"))==null||n.addEventListener("click",o=>{o.preventDefault();const s=sessionStorage.getItem("selectedPackage")||"";L(s)}),(async()=>{try{const o=await fetch("/api/public/config"),s=await o.json();if(!o.ok||!s.ok)return;a&&s.setup_version&&(a.hidden=!1,a.innerHTML=`<strong>${e("getStarted.version")}:</strong> <span class="setup-version-num">v${s.setup_version}</span> — ${e("getStarted.versionHint")}`);const l=`https://wa.me/${s.support_phone_digits||"38348707880"}?text=${C()}`;t&&(t.href=l)}catch{t&&(t.href=`https://wa.me/38348707880?text=${C()}`)}})()}function Te(){const t=document.getElementById("pay-stripe-cta"),a=document.querySelectorAll("[data-pay-bank]");a.forEach(i=>{i.addEventListener("click",n=>{var l;n.preventDefault(),a.forEach(u=>u.classList.remove("is-selected")),i.classList.add("is-selected");const o=document.getElementById("pay-hint"),s=i.dataset.payBank||"raiffeisen",r=sessionStorage.getItem("selectedPackage")||"";if(r==="p4"){o&&(o.hidden=!1,o.textContent=e("packages.p4.summary"));return}if(r==="p1"||r==="p2"||r==="p3"){Ce(r,s);return}o&&(o.hidden=!1,o.textContent=e("pay.pickPlan")),(l=document.getElementById("pakot"))==null||l.scrollIntoView({behavior:"smooth"})})}),t==null||t.addEventListener("click",()=>{var o;const i=sessionStorage.getItem("selectedPackage")||"",n=document.getElementById("pay-hint");if(i==="p4"){n&&(n.hidden=!1,n.textContent=e("packages.p4.summary"));return}if(i==="p1"||i==="p2"||i==="p3"){window.__stripeEnabled?ae(i):n&&(n.hidden=!1,n.textContent=e("checkout.error"));return}n&&(n.hidden=!1,n.textContent=e("pay.pickPlan")),(o=document.getElementById("pakot"))==null||o.scrollIntoView({behavior:"smooth"})})}function $e(){var k;const t=document.querySelectorAll(".package-card[data-package]"),a=document.getElementById("package-detail"),i=document.getElementById("package-detail-name"),n=document.getElementById("package-detail-summary"),o=document.getElementById("package-detail-list"),s=document.getElementById("contact-package"),r=document.getElementById("packages-one-only");if(!t.length||!a)return;let l=null;const u=()=>{l=null,sessionStorage.removeItem("selectedPackage"),t.forEach(d=>{d.classList.remove("selected"),d.setAttribute("aria-pressed","false")}),a.hidden=!0,s&&(s.value=""),r&&(r.hidden=!0)},h=(d,b={})=>{const y=!!b.force;if(!y&&l&&l!==d){r&&(r.hidden=!1,r.textContent=e("packages.oneOnly"));return}if(!y&&l===d){u();return}const p=`packages.${d}`;if(l=d,t.forEach(m=>{const v=m.dataset.package===d;m.classList.toggle("selected",v),m.setAttribute("aria-pressed",v?"true":"false")}),i.textContent=e(`${p}.name`),n){const m=e(`${p}.summary`);n.textContent=m,n.hidden=!m}o.innerHTML=ee(d,{keys:J[d]}),a.hidden=!1,r&&(r.hidden=!1,r.textContent=e("packages.oneOnly")),s&&(s.value=e(`${p}.name`));const c=document.getElementById("package-detail-cta");c&&(d==="p4"?c.textContent=e("cta.contactAi"):window.__stripeEnabled?c.textContent=e("cta.payStripe"):c.textContent=e("cta.buyPackage"));const f=document.getElementById("package-detail-download");f&&(f.textContent=e("getStarted.cta"),f.hidden=!1),sessionStorage.setItem("selectedPackage",d)};t.forEach(d=>{const b=d.dataset.package,y=p=>{var c;(c=p==null?void 0:p.target)!=null&&c.closest(".how-card-link")||h(b)};d.addEventListener("click",y),d.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),h(b))})}),(k=document.getElementById("package-detail-cta"))==null||k.addEventListener("click",async()=>{var c,f;const d=sessionStorage.getItem("selectedPackage")||"",b=((c=document.getElementById("contact-package"))==null?void 0:c.value.trim())||"";let y="38348707880",p=!!window.__stripeEnabled;try{const m=await fetch("/api/public/config"),v=await m.json();m.ok&&v.ok&&(v.support_phone_digits&&(y=v.support_phone_digits),v.stripe_enabled&&(p=!0,window.__stripeEnabled=!0))}catch{}if(d==="p4"){const m=`Përshëndetje, dua informacion për AI (Pako 4).
Pako: ${b}`;window.open(`https://wa.me/${y}?text=${encodeURIComponent(m)}`,"_blank","noopener,noreferrer");return}if(p&&(d==="p1"||d==="p2"||d==="p3")){(f=document.getElementById("pagesa"))==null||f.scrollIntoView({behavior:"smooth"}),ae(d);return}window.open(Ie(y,d||"p1"),"_blank","noopener,noreferrer")});const g=sessionStorage.getItem("selectedPackage");g&&Pe.includes(g)&&h(g,{force:!0})}async function Ke(){var l,u;const t=document.getElementById("trial-modal");t&&t.remove();let a="+383 48707880",i="38348707880";try{const h=await fetch("/api/public/config"),g=await h.json();h.ok&&g.ok&&(g.support_phone&&(a=g.support_phone),g.support_phone_digits&&(i=g.support_phone_digits))}catch{}const n=encodeURIComponent(e("wa.trial")),o=sessionStorage.getItem("selectedPackage")||"p1",s=document.createElement("div");s.id="trial-modal",s.className="checkout-modal",s.innerHTML=`
    ...
    </div>`,document.body.appendChild(s);const r=()=>s.remove();(l=s.querySelector("#trial-close"))==null||l.addEventListener("click",r),(u=s.querySelector("#trial-setup-link"))==null||u.addEventListener("click",()=>{r(),L(o)}),s.addEventListener("click",h=>{h.target===s&&r()})}function Ee(){document.querySelectorAll("[data-trial-modal]").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),Ke()})})}async function te(){var s,r;const t=document.getElementById("equip-modal");t&&t.remove();let a="38348707880";try{const l=await fetch("/api/public/config"),u=await l.json();l.ok&&u.ok&&u.support_phone_digits&&(a=u.support_phone_digits)}catch{}const i=`https://wa.me/${a}?text=${encodeURIComponent(e("equip.wa"))}`,n=document.createElement("div");n.id="equip-modal",n.className="checkout-modal",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const o=()=>n.remove();(s=n.querySelector("#equip-modal-close"))==null||s.addEventListener("click",o),(r=n.querySelector("#equip-modal-packages"))==null||r.addEventListener("click",()=>{var l;o(),(l=document.getElementById("pakot"))==null||l.scrollIntoView({behavior:"smooth"})}),n.addEventListener("click",l=>{l.target===n&&o()})}function xe(){document.querySelectorAll("[data-equip-modal]").forEach(t=>{t.addEventListener("click",a=>{var i;a.preventDefault(),(i=document.getElementById("nav-mobile"))==null||i.classList.remove("open"),te()})})}const R={company:"REVOLUTION INVEST SH.P.K.",bank:"Raiffeisen Bank Kosovo",account:"1504001010467891",currency:"EUR",nui:"811314567"};async function Ne(){try{const t=await fetch("/api/payments/bank-transfer"),a=await t.json();if(t.ok&&a.ok&&a.account)return{company:a.company||R.company,bank:a.bank||R.bank,account:a.account,currency:a.currency||R.currency,nui:a.nui||R.nui}}catch{}return{...R}}function Ce(t,a){var r,l;const i=document.getElementById("bank-transfer-modal");i&&i.remove();const n=document.createElement("div");n.id="bank-transfer-modal",n.className="checkout-modal",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const o=()=>n.remove();(r=n.querySelector("#bk-cancel"))==null||r.addEventListener("click",o),n.addEventListener("click",u=>{u.target===n&&o()});const s=n.querySelector("#bank-details");Ne().then(u=>{var h;s&&(s.removeAttribute("aria-busy"),s.innerHTML=`
      <div class="bank-detail-row"><span>${e("bank.company")}</span><strong>${u.company}</strong></div>
      <div class="bank-detail-row"><span>${e("bank.bankName")}</span><strong>${u.bank}</strong></div>
      <div class="bank-detail-row"><span>${e("bank.account")}</span><strong class="bank-account-num" id="bk-account">${u.account}</strong></div>
      <div class="bank-detail-row"><span>${e("bank.currency")}</span><strong>${u.currency}</strong></div>
      <div class="bank-detail-row"><span>${e("bank.nui")}</span><strong>${u.nui}</strong></div>
      <button type="button" class="btn btn-ghost bank-copy-btn" id="bk-copy">${e("bank.copy")}</button>`,(h=n.querySelector("#bk-copy"))==null||h.addEventListener("click",async()=>{const g=n.querySelector("#bk-copy");try{await navigator.clipboard.writeText(u.account),g&&(g.textContent=e("bank.copied"))}catch{}}))}),(l=n.querySelector("#bk-submit"))==null||l.addEventListener("click",async()=>{var p,c,f,m,v;const u=n.querySelector("#bk-submit"),h=n.querySelector("#bk-msg"),g=String(((p=n.querySelector("#bk-emri"))==null?void 0:p.value)||"").trim(),k=String(((c=n.querySelector("#bk-biz"))==null?void 0:c.value)||"").trim(),d=String(((f=n.querySelector("#bk-email"))==null?void 0:f.value)||"").trim(),b=String(((m=n.querySelector("#bk-phone"))==null?void 0:m.value)||"").trim(),y=String(((v=n.querySelector("#bk-tipi"))==null?void 0:v.value)||"restorant");if(!g||!k||!d){h&&(h.hidden=!1,h.textContent=e("bank.error"));return}u&&(u.disabled=!0,u.textContent=e("bank.busy"));try{const A=await fetch("/api/payments/bank-transfer/request",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plan:t,bank:a,emri:g,emri_biznesit:k,email:d,telefoni:b,tipi:y})}),K=await A.json();if(!A.ok||!K.ok)throw new Error(K.gabim||e("bank.error"));h&&(h.hidden=!1,h.classList.add("checkout-msg-ok"),h.textContent=K.message||e("bank.success")),u&&(u.disabled=!0,u.textContent=e("bank.submit"))}catch(A){h&&(h.hidden=!1,h.textContent=A.message||e("bank.error")),u&&(u.disabled=!1,u.textContent=e("bank.submit"))}})}function ae(t){var o,s;const a=document.getElementById("stripe-checkout-modal");a&&a.remove();const i=document.createElement("div");i.id="stripe-checkout-modal",i.className="checkout-modal",i.innerHTML=`
    ...
    </div>`,document.body.appendChild(i);const n=()=>i.remove();(o=i.querySelector("#co-cancel"))==null||o.addEventListener("click",n),i.addEventListener("click",r=>{r.target===i&&n()}),(s=i.querySelector("#co-pay"))==null||s.addEventListener("click",async()=>{var b,y,p,c,f;const r=i.querySelector("#co-pay"),l=i.querySelector("#co-msg"),u=String(((b=i.querySelector("#co-emri"))==null?void 0:b.value)||"").trim(),h=String(((y=i.querySelector("#co-biz"))==null?void 0:y.value)||"").trim(),g=String(((p=i.querySelector("#co-email"))==null?void 0:p.value)||"").trim(),k=String(((c=i.querySelector("#co-phone"))==null?void 0:c.value)||"").trim(),d=String(((f=i.querySelector("#co-tipi"))==null?void 0:f.value)||"restorant");if(!u||!h||!g){l&&(l.hidden=!1,l.textContent=e("checkout.error"));return}r&&(r.disabled=!0,r.textContent=e("checkout.busy"));try{const m=await fetch("/api/payments/checkout",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plan:t,emri:u,emri_biznesit:h,email:g,telefoni:k,tipi:d})}),v=await m.json();if(!m.ok||!v.ok||!v.url)throw new Error(v.gabim||e("checkout.error"));window.location.href=v.url}catch(m){l&&(l.hidden=!1,l.textContent=m.message||e("checkout.error")),r&&(r.disabled=!1,r.textContent=e("checkout.pay"))}})}function Q(){var i,n;const t=be(),a=j();document.title=e("meta.title"),(n=document.querySelector('meta[name="description"]'))==null||n.setAttribute("content",((i=M[a])==null?void 0:i["meta.description"])??M.sq["meta.description"]),document.getElementById("app").innerHTML=`
    ${F({activeNav:"home"})}
    <main>
      <section class="hero hero-with-image hero-home" id="ballina" style="--hero-image: url('${Se}')">
      ...
      <section class="site-section spotlight-section" id="veçorite">
        <div class="container">
          ...
          <div class="spotlight-grid spotlight-grid--single">
            ${Ae({variant:"platform",categoryKey:"spotlight.card2.category",titleKey:"spotlight.card2.title",descKey:"spotlight.card2.desc",linkKey:"spotlight.card2.link",href:"#pakot"})}
          </div>
        </div>
      </section>
      ...
      <section class="site-section get-started-section" id="si-ta-ngarkoni">
        <div class="container">
          ...
          <div class="get-started-actions">
            <button type="button" class="btn btn-primary" id="get-started-download">${e("getStarted.cta")}</button>
    ...
    ${W()}
    ${B()}
  `,H(),_(),V(),D(),$e(),ze(),Me(),Te(),Ee(),xe(),Oe(),window.location.hash==="#pajisjet"?(history.replaceState(null,"",`${window.location.pathname}${window.location.search}`||"/"),te()):window.location.hash?requestAnimationFrame(()=>{var o;(o=document.querySelector(window.location.hash))==null||o.scrollIntoView({behavior:"smooth"})}):window.scrollTo(0,0)}function Le(t){const a=ye(t);if(!a){Q();return}document.title=`${a.title} — Revolution POS`,document.getElementById("app").innerHTML=`
    ${F({activeNav:"blog"})}
      ...
      <div class="container">
        ...
        <article class="article-full">
          ...
          <div class="article-full-image">
            ${G(a.slug,{alt:a.title,loading:"eager"})}
          </div>
    ...
    ${W()}
    ${B()}
  `,H(),_(),V(),D(),window.scrollTo(0,0)}const Fe={privacy:{sq:{title:"Privatësia e të dhënave",updated:"Përditësuar: qershor 2026",content:`
      ...
      `}}};function We(t){const a=Fe[t];if(!a)return null;const i=j();return a[i]??a.sq}function ie(t){const a=We(t);if(!a){Q();return}document.title=`${a.title} — Revolution Invest POS`,document.getElementById("app").innerHTML=`
    ${F({activeNav:"home"})}
    ...
    ${W()}
    ${B()}
  `,H(),_(),V(),D(),window.scrollTo(0,0)}T("/",()=>Q());T("/privacy",()=>ie("privacy"));T("/terms",()=>ie("terms"));T("/blog/:slug",({slug:t})=>Le(t));oe();
