(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const N=[];function $(t,a){const n=[],i=new RegExp("^"+t.replace(/\//g,"\\/").replace(/:([a-zA-Z]+)/g,(o,r)=>(n.push(r),"([^/]+)"))+"$");N.push({regex:i,keys:n,handler:a})}function ie(t){const a=t.indexOf("#"),n=a>=0?t.slice(a+1):"",i=a>=0?t.slice(0,a)||"/":t;window.history.pushState({},"",n?`${i}#${n}`:i),K(),n&&requestAnimationFrame(()=>{var o;(o=document.getElementById(n))==null||o.scrollIntoView({behavior:"smooth"})})}function P(){return window.location.pathname.replace(/\/+$/,"")||"/"}function K(){var a;const t=P();for(const n of N){const i=t.match(n.regex);if(!i)continue;const o={};n.keys.forEach((r,s)=>{o[r]=decodeURIComponent(i[s+1])}),n.handler(o);return}(a=N.find(n=>n.regex.source==="^\\/$"))==null||a.handler({})}function ne(){document.addEventListener("click",t=>{const a=t.target.closest("a[data-navigate]");a&&(t.metaKey||t.ctrlKey||t.shiftKey||t.altKey||(t.preventDefault(),ie(a.getAttribute("href"))))}),window.addEventListener("popstate",K),K()}const Q={sq:{navLabel:"Kryesore",langLabel:"Gjuha",features:"Veçoritë",howItWorks:"Si funksionon",packages:"Paketat",faq:"FAQ",blog:"Blog",backToTop:"Kthehu lart",blogBadge:"Blog",heroTitle:"Këshilla & Njohuri për",heroAccent:"Restorante Moderne",heroSubtitle:"Artikuj praktikë për menaxhimin e restorantit, teknologjinë POS dhe eficiencën operacionale.",readMore:"Lexo →",backToBlog:"← Kthehu në ballina",pageTitle:"Revolution Invest POS — Restorante & Kafene",metaDescription:"Këshilla dhe njohuri për restorante moderne — menaxhim, POS, teknologji dhe eficiencë operacionale."},en:{navLabel:"Main navigation",langLabel:"Language",features:"Features",howItWorks:"How it works",packages:"Pricing",faq:"FAQ",blog:"Blog",backToTop:"Back to top",blogBadge:"Blog",heroTitle:"Tips & Insights for",heroAccent:"Modern Restaurants",heroSubtitle:"Practical articles on restaurant management, POS technology, and operational efficiency.",readMore:"Read →",backToBlog:"← Back to home",pageTitle:"Revolution Invest POS — Restaurants & Cafés",metaDescription:"Tips and insights for modern restaurants — management, POS, technology, and operational efficiency."}},M={sq:{"meta.title":"Revolution Invest POS — Sistemi POS për Restorantet, Kafenetë & Dyqanet","meta.description":"Revolution Invest POS — platformë e plotë për restorante, kafene dhe dyqane. POS, kuzhinë, kamarier, faqe publike /r/ & /s/, porosi online dhe offline me sync.","brand.subtitle":"Restorant · Kafene · Dyqan","nav.home":"Ballina","nav.howItWorks":"Si funksionon","nav.getStarted":"Si ta ngarkoni","nav.packages":"Pakot","nav.blog":"Blog","nav.manual":"Manuali","nav.contact":"Kontakti","nav.openMenu":"Hap menunë","getStarted.title":"Si ta ngarkoni programin — hap pas hapi","getStarted.subtitle":"Shkarkoni Setup vetë nga kjo faqe — pa pritur WhatsApp. Pastaj instaloni dhe aktivizoni.","getStarted.s1.title":"1. Zgjidhni pakon","getStarted.s1.desc":"Shikoni Pakot (Standard, Pro, Full ose AI) dhe zgjidhni atë që ju duhet.","getStarted.s2.title":"2. Shkarkoni Setup","getStarted.s2.desc":"Shtypni «Shkarko Setup» — skedari .exe shkarkohet drejt në kompjuterin tuaj.","getStarted.s3.title":"3. Instaloni programin","getStarted.s3.desc":"Hapni Setup.exe dhe ndiqni dritaren e instalimit (Windows).","getStarted.s4.title":"4. Hapni aktivizimin","getStarted.s4.desc":"Në fund hapet «Aktivizo KAFENE» me ID e pajisjes (XXXX-XXXX-XXXX-XXXX).","getStarted.s5.title":"5. Licenca / trial","getStarted.s5.desc":"Për trial 7 ditë ose pagesë vjetore — paguani më poshtë (Stripe) ose na shkruani për çelës.","getStarted.s6.title":"6. Filloni punën","getStarted.s6.desc":"Ngjitni License Key te ekrani i aktivizimit — pastaj punoni normalisht.","getStarted.cta":"Shkarko Setup (Windows)","getStarted.ctaHelp":"Ndihmë në WhatsApp","getStarted.note":"Pako 4 (AI) aktivizohet vetëm me lejen tonë. Setup e shkarkoni vetë — pagesa më poshtë.","cta.startFree":"Fillo Falas","cta.choosePackage":"Zgjidh Pakon","cta.buyPackage":"Shkarko / Paguaj","cta.downloadSetup":"Shkarko Setup","cta.payStripe":"Paguaj me kartë (Stripe)","cta.contactAi":"Kontaktoni për AI","pay.title":"Pagesa","pay.subtitle":"Paguani me kartë (Stripe) ose me bankat vendore — zgjidhni mënyrën që ju përshtatet.","pay.stripe":"Kartë — Stripe","pay.stripeDesc":"Visa, Mastercard dhe Stripe","pay.banks":"Banka vendore","pay.banksDesc":"Transfer bankar te llogaria e Revolution Invest","pay.soon":"Së shpejti","pay.active":"Aktiv","pay.ctaStripe":"Vazhdo me Stripe","pay.pickPlan":"Zgjidhni një pako (1–3) më lart, pastaj paguani këtu.","pay.bankHint":"Zgjidhni pakon (1–3) më lart, pastaj klikoni bankën — shfaqet numri i llogarisë për transfer.","pay.bank.teb":"TEB","pay.bank.raiffeisen":"Raiffeisen","pay.bank.nlb":"NLB","pay.bank.bkt":"BKT","pay.bank.procredit":"ProCredit","pay.bank.bpb":"BPB","bank.title":"Pagesë me transfer bankar","bank.intro":"Transferoni te llogaria më poshtë (Kosovë). Fatura e rregullt PDF (me vulë, nënshkrim dhe datë) dërgohet me email VETËM pasi të konfirmojmë pagesën në bankë — jo para.","bank.company":"Përfituesi","bank.bankName":"Banka","bank.account":"Nr. llogarisë","bank.currency":"Monedha","bank.nui":"NUI","bank.copy":"Kopjo nr. llogarisë","bank.copied":"U kopjua!","bank.submit":"Dërgo kërkesën (pas transferit)","bank.busy":"Duke dërguar…","bank.success":"Faleminderit! Kryeni transferin. Kur pagesa të shfaqet te ne, ju dërgojmë me email faturën PDF (vulë/datë) dhe çelësin e licencës. Pa konfirmim pagese nuk lëshohet faturë.","bank.error":"Kërkesa nuk u dërgua. Provoni përsëri ose WhatsApp.","checkout.title":"Pagesa me kartë — licenca (1 vit)","checkout.emri":"Emri juaj","checkout.biznesi":"Emri i biznesit","checkout.email":"Email","checkout.telefoni":"Telefoni","checkout.tipi":"Lloji i biznesit","checkout.pay":"Vazhdo te pagesa me kartë","checkout.cancel":"Anulo","checkout.busy":"Duke hapur Stripe…","checkout.error":"Pagesa nuk u hap. Provoni përsëri ose WhatsApp.","checkout.success":"Pagesa u krye! Shkarkoni Setup nga faqja dhe aktivizoni me çelësin që ju dërgojmë.","checkout.tipi.restorant":"Restorant","checkout.tipi.kafene":"Kafene","checkout.tipi.dyqan":"Dyqan","cta.contactUs":"Na Kontaktoni","cta.sendRequest":"Dërgo kërkesën","expand.more":"Lexo më shumë","expand.less":"Më pak","hero.badge":"Provë falas 7 ditë","hero.title":"Kontrollo çdo Porosi. Çdo Tavolinë. Çdo Ditë.","hero.subtitle":"Nga kasa te kuzhina, nga kamarieri te pronari — plus stok, fatura, faqe publike për restorante & dyqane, porosi online dhe punë offline. Gjithçka në një platformë.","hero.cta.primary":"Fillo 7 ditë falas","hero.cta.secondary":"Shiko veçoritë →","trialModal.title":"Provë falas — 7 ditë","trialModal.body":"Shkarkoni Setup vetë nga faqja, instaloni, pastaj na shkruani për License Key (trial 7 ditë) ose paguani me Stripe.","trialModal.phoneLabel":"Telefon / WhatsApp","trialModal.phone":"+383 48707880","trialModal.download":"Shkarko Setup","trialModal.wa":"WhatsApp — kërko çelës trial","trialModal.close":"Mbyll","hero.stats.restaurants":"500+ Restorante","hero.stats.support":"24/7 Mbështetje","hero.stats.cloud":"Cloud & Offline","spotlight.title":"Çfarë përfshin programi","spotlight.subtitle":"Module profesionale që punojnë së bashku — nga operimi ditor te prezenca digjitale e biznesit tuaj.","spotlight.card1.category":"MENAXHIM","spotlight.card1.title":"Stoku, Faturat dhe Raportet","spotlight.card1.desc":"Inventar me përbërës dhe alarme stoku, fatura fiskale termike dhe raporte Z — kontroll i plotë mbi operacionet e restorantit.","spotlight.card1.link":"Lexo →","spotlight.card2.category":"PLATFORMË","spotlight.card2.title":"Restorant, Kafene & Dyqan — Faqe Publike për Çdo Lokal","spotlight.card2.desc":"Menu digjitale /r/ për restorante, vitrinë produktesh /s/ për dyqane, porosi online, rezervime tavolinash, offline me sync dhe panel pronari nga telefoni.","spotlight.card2.link":"Shiko pakot →","how.title":"Si funksionon sistemi","how.subtitle":"Katër module të lidhura — porosia shkon nga tavolina te kuzhina, pronari sheh gjithçka live, klienti gjen lokalin tuaj online.","how.pos.title":"POS Kasa","how.pos.desc":"Shitje të shpejta, tavolina, pagesa, fatura fiskale dhe printim termik — qendra e operimit të restorantit ose dyqanit tuaj.","how.waiter.title":"Kamarieri","how.waiter.desc":"Tablet ose telefon — merr porosi nga tavolina, punon edhe offline dhe i dërgon automatikisht në kuzhinë kur kthehet interneti.","how.kds.title":"KDS Kuzhina","how.kds.desc":"Ekran dixhital — porositë shfaqen live, stafi konfirmon gatishmërinë dhe servimi bëhet pa gabime.","how.owner.title":"Pronari","how.owner.desc":"Panel online — menu, stok, stafi, rezervime, faqja publike, raporte dhe QR — menaxhim i plotë nga kudo.","how.readManual":"Lexo në manual →","packages.title":"Pakot — çfarë përmban secila","packages.subtitle":"Zgjidhni vetëm një pako. Shihni çfarë përfshin; për çmime dhe oferta kontaktoni telefon ose email. Pagesa me kartë (Stripe) kur jeni gati.","packages.badge":"1 pako","packages.priceHint":"Për çmime / oferta: WhatsApp ose email — nuk shfaqen publike.","packages.oneOnly":"Mund të zgjidhni vetëm një pako. Për të ndryshuar, klikoni përsëri pakon e zgjedhur.","packages.p1.name":"Pako 1 — Standard","packages.p1.tagline":"POS + KDS + kamarier + kiosk + cloud","packages.p1.summary":"Manual — Pako 1: kasa POS, ekran kuzhine (KDS), kamarier nga telefoni, kiosk QR, sync cloud dhe panel pronari. Pa porosi online. Pa AI.","packages.p1.incl":"Përmban:","packages.p1.f1":"Kasa POS — tavolina, pagesa, printer","packages.p1.f2":"KDS — porosi live në kuzhinë","packages.p1.f3":"Kamarier — tablet / telefon","packages.p1.f4":"Kiosk QR nga tavolina","packages.p1.f5":"Cloud sync & panel pronari","packages.p1.f6":"Faqe publike menu (/r/)","packages.p2.name":"Pako 2 — Pro","packages.p2.tagline":"Gjithçka nga Standard + porosi online","packages.p2.summary":"Manual — Pako 2: e gjithë Pako 1, plus takeaway & delivery nga faqja. Ideal kur klienti porosit edhe jashtë lokalit. Pa AI.","packages.p2.incl":"Përmban (plus Pako 1):","packages.p2.f1":"Porosi online — takeaway & delivery","packages.p2.f2":"Faqe me porosi direkte","packages.p2.f3":"Sync porosive me POS & kuzhinë","packages.p2.f4":"Prano / refuzo porosi","packages.p2.f5":"Raporte nga të gjitha kanalet","packages.p2.f6":"Mbështetje prioritet","packages.p3.name":"Pako 3 — Full","packages.p3.tagline":"I plotë pa AI","packages.p3.summary":"Manual — Pako 3: POS, KDS, kamarier, kiosk, cloud, porosi online — paketa e plotë operative. Pa module AI (AI vetëm Pako 4 me leje).","packages.p3.incl":"Përmban (plus Pako 2):","packages.p3.f1":"POS + KDS + kamarier + kiosk","packages.p3.f2":"Porosi online (takeaway & delivery)","packages.p3.f3":"Cloud sync & backup","packages.p3.f4":"Kontabilisti ATK (libra / TVSH)","packages.p3.f5":"Panel i plotë (menu, stok, staf)","packages.p3.f6":"Pa AI — AI vetëm me leje (Pako 4)","packages.p4.name":"Pako 4 — AI","packages.p4.tagline":"Full + AI — vetëm me leje","packages.p4.summary":"Manual — Pako 4: gjithçka nga Full + AI. Nuk aktivizohet online vetë. Vetëm pasi na kontaktoni dhe e lejojmë manualisht.","packages.p4.incl":"Përmban (plus Pako 3):","packages.p4.f1":"Skanim AI — fatura / menu","packages.p4.f2":"Asistent AI për pronarin","packages.p4.f3":"Parashikim stoku & raporte AI","packages.p4.f4":"Kontroll tokenësh nga admini","packages.p4.f5":"Aktivizim VETËM me lejen tonë","packages.p4.f6":"Kontaktoni për AI — jo blerje automatike","packages.clickHint":"Zgjidhni një pako (vetëm një). Pastaj vazhdoni me pagesë ose kontakt.","packages.includes":"Çfarë përmban kjo pako:","packages.selected":"Zgjedhur — vetëm kjo pako","contact.title":"Filloni sot — trial 7 ditë","contact.subtitle":"Na kontaktoni në WhatsApp për trial, instalim Setup.exe dhe zgjedhjen e pakos (Standard, Pro, Full ose AI).","contact.direct":"Kontakt i drejtpërdrejtë","contact.email":"revolutioninvest05@gmail.com","contact.sendMessage":"Dërgo mesazh","form.name":"Emri","form.phone":"Telefoni","form.message":"Mesazhi","form.namePlaceholder":"Emri i biznesit","form.messagePlaceholder":"P.sh. Restorant me 15 tavolina ose dyqan me 200 produkte…","form.error":"Plotësoni të gjitha fushat.","form.success":"Faleminderit! Po ju hapim WhatsApp për të dërguar kërkesën.","footer.tagline":"Sistemi i plotë POS për restorante, kafene, bare dhe dyqane — porosi, kuzhinë, stok, faqe publike dhe menaxhim nga një vend.","footer.note":"Zhvilluar dhe mirëmbajtur nga ekipi ynë në Kosovë dhe rajon.","footer.col.platform":"Platforma","footer.col.support":"Ndihmë & kontakt","footer.link.howItWorks":"Si funksionon","footer.link.packages":"Pakot & modulet","footer.link.blog":"Artikuj & këshilla","footer.link.manual":"Manuali i përdorimit","footer.link.contact":"Na kontaktoni","footer.link.trial":"Fillo provën falas","footer.legal.privacy":"Privatësia e të dhënave","footer.legal.terms":"Kushtet e shërbimit","footer.legal.notice":"Revolution Invest POS ofrohet me licencë të rregullt. Të dhënat e biznesit tuaj ruhen në mënyrë të sigurt sipas politikës sonë të privatësisë.","footer.rights":"Revolution Invest. Të gjitha të drejtat e rezervuara.","wa.trial":"Përshëndetje, dëshiroj të provoj Revolution Invest POS.","wa.custom":"Përshëndetje, dëshiroj të diskutoj për zgjidhje të personalizuara.","wa.formIntro":"Përshëndetje, jam {name} ({phone}).","wa.formSuffix":"Dëshiroj Revolution Invest POS — trial 7 ditë.","legal.backHome":"← Kthehu në ballina","articles.heading":"Artikujt e fundit"},en:{"meta.title":"Revolution Invest POS — POS for Restaurants, Cafés & Shops","meta.description":"Revolution Invest POS — full platform for restaurants, cafés and retail. POS, kitchen, waiter, public pages /r/ & /s/, online orders and offline sync.","brand.subtitle":"Restaurant · Café · Shop","nav.home":"Home","nav.howItWorks":"How it works","nav.getStarted":"How to install","nav.packages":"Pricing","nav.blog":"Blog","nav.manual":"Manual","nav.contact":"Contact","nav.openMenu":"Open menu","getStarted.title":"How to install the program — step by step","getStarted.subtitle":"Download Setup yourself from this page — no waiting on WhatsApp. Then install and activate.","getStarted.s1.title":"1. Choose a plan","getStarted.s1.desc":"See Packages (Standard, Pro, Full or AI) and pick what you need.","getStarted.s2.title":"2. Download Setup","getStarted.s2.desc":"Tap «Download Setup» — the .exe file downloads to your computer.","getStarted.s3.title":"3. Install the app","getStarted.s3.desc":"Open Setup.exe and follow the Windows installer.","getStarted.s4.title":"4. Open activation","getStarted.s4.desc":"At the end «Activate KAFENE» opens with your device ID (XXXX-XXXX-XXXX-XXXX).","getStarted.s5.title":"5. License / trial","getStarted.s5.desc":"For a 7-day trial or annual license — pay below (Stripe) or message us for a key.","getStarted.s6.title":"6. Start working","getStarted.s6.desc":"Paste the License Key on the activation screen — then work normally.","getStarted.cta":"Download Setup (Windows)","getStarted.ctaHelp":"Help on WhatsApp","getStarted.note":"Plan 4 (AI) needs our approval. Download Setup yourself — pay below.","cta.startFree":"Start Free","cta.choosePackage":"Choose Plan","cta.buyPackage":"Download / Pay","cta.downloadSetup":"Download Setup","cta.payStripe":"Pay by card (Stripe)","cta.contactAi":"Contact for AI","pay.title":"Payment","pay.subtitle":"Pay by card (Stripe) or via local banks — choose what works for you.","pay.stripe":"Card — Stripe","pay.stripeDesc":"Visa, Mastercard and Stripe","pay.banks":"Local banks","pay.banksDesc":"Bank transfer to Revolution Invest","pay.soon":"Soon","pay.active":"Active","pay.ctaStripe":"Continue with Stripe","pay.pickPlan":"Select a plan (1–3) above, then pay here.","pay.bankHint":"Select a plan (1–3) above, then click a bank — account number for transfer will appear.","pay.bank.teb":"TEB","pay.bank.raiffeisen":"Raiffeisen","pay.bank.nlb":"NLB","pay.bank.bkt":"BKT","pay.bank.procredit":"ProCredit","pay.bank.bpb":"BPB","bank.title":"Pay by bank transfer","bank.intro":"Transfer to the account below (Kosovo). The regular PDF invoice (stamp, signature, date) is emailed ONLY after we confirm the bank payment — not before.","bank.company":"Beneficiary","bank.bankName":"Bank","bank.account":"Account number","bank.currency":"Currency","bank.nui":"NUI","bank.copy":"Copy account number","bank.copied":"Copied!","bank.submit":"Submit request (after transfer)","bank.busy":"Sending…","bank.success":"Thank you! Complete the transfer. When the payment appears on our side we email the PDF invoice (stamp/date) and license key. No invoice without payment confirmation.","bank.error":"Request failed. Try again or WhatsApp.","checkout.title":"Card payment — license (1 year)","checkout.emri":"Your name","checkout.biznesi":"Business name","checkout.email":"Email","checkout.telefoni":"Phone","checkout.tipi":"Business type","checkout.pay":"Continue to card payment","checkout.cancel":"Cancel","checkout.busy":"Opening Stripe…","checkout.error":"Checkout failed. Try again or WhatsApp.","checkout.success":"Payment done! Download Setup from the site and activate with the key we send.","checkout.tipi.restorant":"Restaurant","checkout.tipi.kafene":"Café","checkout.tipi.dyqan":"Shop","cta.contactUs":"Contact Us","cta.sendRequest":"Send request","expand.more":"Read more","expand.less":"Show less","hero.badge":"7-day free trial","hero.title":"Control Every Order. Every Table. Every Day.","hero.subtitle":"From register to kitchen, waiter to owner — plus stock, invoices, public pages for restaurants & shops, online orders and offline work. All in one platform.","hero.cta.primary":"Start 7-day free trial","hero.cta.secondary":"See features →","trialModal.title":"Free trial — 7 days","trialModal.body":"Download Setup yourself, install, then message us for a License Key (7-day trial) or pay with Stripe.","trialModal.phoneLabel":"Phone / WhatsApp","trialModal.phone":"+383 48707880","trialModal.download":"Download Setup","trialModal.wa":"WhatsApp — request trial key","trialModal.close":"Close","hero.stats.restaurants":"500+ Restaurants","hero.stats.support":"24/7 Support","hero.stats.cloud":"Cloud & Offline","spotlight.title":"What's inside the platform","spotlight.subtitle":"Professional modules that work together — from daily operations to your business's digital presence.","spotlight.card1.category":"MANAGEMENT","spotlight.card1.title":"Inventory, Invoices & Reports","spotlight.card1.desc":"Ingredient inventory with stock alerts, fiscal receipts and Z-reports — full control over restaurant operations.","spotlight.card1.link":"Read →","spotlight.card2.category":"PLATFORM","spotlight.card2.title":"Restaurant, Café & Shop — A Public Page for Every Venue","spotlight.card2.desc":"Digital menu /r/ for restaurants, product storefront /s/ for shops, online orders, table reservations, offline sync and owner panel from your phone.","spotlight.card2.link":"View plans →","how.title":"How the system works","how.subtitle":"Four connected modules — orders flow from table to kitchen, the owner sees everything live, guests find you online.","how.pos.title":"POS Register","how.pos.desc":"Take orders, issue fiscal invoices, and manage tables — the hub of your restaurant operations.","how.waiter.title":"Waiter","how.waiter.desc":"Tablet or phone — take orders directly from the table and send them automatically to the kitchen.","how.kds.title":"Kitchen KDS","how.kds.desc":"Digital screen — see orders in real time and confirm when a dish is ready to serve.","how.owner.title":"Owner","how.owner.desc":"Online panel — view reports, manage menu and staff from anywhere, even your phone.","how.readManual":"Read in manual →","packages.title":"Plans — what's in each package","packages.subtitle":"Choose only one plan. See what's included; for pricing contact phone or email. Card payment (Stripe) when ready.","packages.badge":"1 plan","packages.priceHint":"For prices / offers: WhatsApp or email — not shown publicly.","packages.oneOnly":"You can select only one plan. To change, click the selected plan again.","packages.p1.name":"Plan 1 — Standard","packages.p1.tagline":"POS + KDS + waiter + kiosk + cloud","packages.p1.summary":"Guide — Plan 1: POS register, kitchen display, waiter app, QR kiosk, cloud sync and owner panel. No online orders. No AI.","packages.p1.incl":"Includes:","packages.p1.f1":"POS register — tables, payments, printer","packages.p1.f2":"KDS — live kitchen orders","packages.p1.f3":"Waiter — tablet / phone","packages.p1.f4":"QR kiosk from the table","packages.p1.f5":"Cloud sync & owner panel","packages.p1.f6":"Public menu page (/r/)","packages.p2.name":"Plan 2 — Pro","packages.p2.tagline":"Everything in Standard + online orders","packages.p2.summary":"Guide — Plan 2: all of Plan 1, plus takeaway & delivery from the public page. No AI.","packages.p2.incl":"Includes (plus Plan 1):","packages.p2.f1":"Online orders — takeaway & delivery","packages.p2.f2":"Public page with direct ordering","packages.p2.f3":"Order sync to POS & kitchen","packages.p2.f4":"Accept / refuse orders","packages.p2.f5":"Reports across all channels","packages.p2.f6":"Priority support","packages.p3.name":"Plan 3 — Full","packages.p3.tagline":"Complete without AI","packages.p3.summary":"Guide — Plan 3: POS, KDS, waiter, kiosk, cloud, online orders — full ops package. AI only in Plan 4 with our approval.","packages.p3.incl":"Includes (plus Plan 2):","packages.p3.f1":"POS + KDS + waiter + kiosk","packages.p3.f2":"Online orders (takeaway & delivery)","packages.p3.f3":"Cloud sync & backup","packages.p3.f4":"ATK accountant (books / VAT)","packages.p3.f5":"Full panel (menu, stock, staff)","packages.p3.f6":"No AI — AI only with approval (Plan 4)","packages.p4.name":"Plan 4 — AI","packages.p4.tagline":"Full + AI — approval required","packages.p4.summary":"Guide — Plan 4: everything in Full + AI. Not self-activated online. Only after you contact us and we enable it.","packages.p4.incl":"Includes (plus Plan 3):","packages.p4.f1":"AI scan — invoices / menu","packages.p4.f2":"AI assistant for owners","packages.p4.f3":"Stock forecast & AI reports","packages.p4.f4":"Token control by admin","packages.p4.f5":"Activation ONLY with our approval","packages.p4.f6":"Contact for AI — no automatic purchase","packages.clickHint":"Select one plan only. Then pay by card or contact us.","packages.includes":"What's in this plan:","packages.selected":"Selected — this plan only","contact.title":"Start today — 7-day trial","contact.subtitle":"Contact us on WhatsApp for trial, Setup.exe install, and choosing Standard, Pro, Full or AI.","contact.direct":"Direct contact","contact.email":"revolutioninvest05@gmail.com","contact.sendMessage":"Send a message","form.name":"Name","form.phone":"Phone","form.message":"Message","form.namePlaceholder":"Business name","form.messagePlaceholder":"E.g. Restaurant with 15 tables in Pristina…","form.error":"Please fill in all fields.","form.success":"Thank you! Opening WhatsApp so you can send your request.","footer.tagline":"The complete POS system for restaurants, cafés, and bars — orders, kitchen, reports, and management from one place.","footer.note":"Developed and maintained by our team in Kosovo and the region.","footer.col.platform":"Platform","footer.col.support":"Help & contact","footer.link.howItWorks":"How it works","footer.link.packages":"Plans & modules","footer.link.blog":"Articles & tips","footer.link.manual":"User manual","footer.link.contact":"Contact us","footer.link.trial":"Start free trial","footer.legal.privacy":"Data privacy","footer.legal.terms":"Terms of service","footer.legal.notice":"Revolution Invest POS is provided under a standard license. Your business data is stored securely in line with our privacy policy.","footer.rights":"Revolution Invest. All rights reserved.","wa.trial":"Hello, I would like to try Revolution Invest POS.","wa.custom":"Hello, I would like to discuss a tailored solution.","wa.formIntro":"Hello, I'm {name} ({phone}).","wa.formSuffix":"I want Revolution Invest POS — 1 month free.","legal.backHome":"← Back to home","articles.heading":"Latest articles"}},U="revolution-pos-lang";let w=localStorage.getItem(U)||"sq";function S(){return w}function oe(t){t!=="sq"&&t!=="en"||(w=t,localStorage.setItem(U,w),document.documentElement.lang=w==="en"?"en":"sq")}function e(t){var a,n;return((a=Q[w])==null?void 0:a[t])??((n=M[w])==null?void 0:n[t])??Q.sq[t]??M.sq[t]??t}document.documentElement.lang=w==="en"?"en":"sq";function x(){return"/"}function re(){return"/blog"}function se(t){return`${re()}/${t}`.replace(/\/+/g,"/")}function R(t){return`/${t.replace(/^\//,"")}`}function C(t){return P()==="/"?`#${t}`:`/#${t}`}function O(t,a,n,i){const o=P()==="/";return`<a href="${C(t)}"${o?"":" data-navigate"} class="${n===i?"active":""}">${a}</a>`}function F({activeNav:t="home"}={}){const a=S(),n=[{id:"home",label:e("nav.home"),section:"ballina"},{id:"get-started",label:e("nav.getStarted"),section:"si-ta-ngarkoni"},{id:"how-it-works",label:e("nav.howItWorks"),section:"si-funksionon"},{id:"packages",label:e("nav.packages"),section:"pakot"},{id:"blog",label:e("nav.blog"),section:"artikuj"}];return`
    <header class="site-header">
      <div class="container header-inner">
        ...
        <nav class="nav nav-desktop" aria-label="${e("navLabel")}">
          ${n.map(i=>O(i.section,i.label,t,i.id)).join("")}
          <a href="/website/manual.html">${e("nav.manual")}</a>
          ${O("kontakt",e("nav.contact"),t,"contact")}
        </nav>
        ...
        <div class="header-actions">
          ...
          <a class="btn btn-primary header-cta-desktop" href="${C("kontakt")}">${e("cta.startFree")}</a>
      ...
      <nav class="nav-mobile" id="nav-mobile" aria-label="${e("navLabel")}">
        ...
        <a href="/website/manual.html">${e("nav.manual")}</a>
        ${O("kontakt",e("nav.contact"),t,"contact")}
        <a class="btn btn-primary" href="${C("kontakt")}">${e("cta.startFree")}</a>
      </nav>
    </header>
  `}function A(t,a){const n=P()==="/";return`<li><a href="${n?`#${t}`:`/#${t}`}"${n?"":" data-navigate"}>${a}</a></li>`}function L(){const a=P()==="/"?"":" data-navigate";return`
    <footer class="site-footer">
      <div class="container footer-grid">
        <div class="footer-brand">
          <a class="footer-logo" href="${x()}"${a} aria-label="Revolution Invest POS">
            <span class="brand-mark" aria-hidden="true">
              <img src="${R("logo-source.png")}" width="40" height="40" alt="" />
            </span>
        ...
        <div class="footer-col">
          ...
          <ul>
            ${A("si-ta-ngarkoni",e("nav.getStarted"))}
            ${A("si-funksionon",e("footer.link.howItWorks"))}
            ${A("pakot",e("footer.link.packages"))}
            ${A("artikuj",e("footer.link.blog"))}
        ...
        <div class="footer-col" id="kontakt">
          ...
          <ul>
            ${A("kontakt",e("footer.link.contact"))}
  ...
  `}function D(){const t=document.getElementById("footer-whatsapp");if(!t)return;async function a(){try{const n=await fetch("/api/public/config"),i=await n.json();if(!n.ok||!i.ok)return;const o=i.support_phone||"+383 48707880",r=i.support_phone_digits||"38348707880";t.textContent=`WhatsApp — ${o}`,t.href=`https://wa.me/${r}?text=${encodeURIComponent(e("wa.trial"))}`}catch{t.textContent="WhatsApp",t.href=`https://wa.me/38348707880?text=${encodeURIComponent(e("wa.trial"))}`}}a()}function W(){return`<button id="back-to-top" class="back-to-top" type="button" aria-label="${e("backToTop")}">↑</button>`}function B(){const t=document.querySelector("#back-to-top");if(!t)return;const a=()=>{t.classList.toggle("visible",window.scrollY>400)};window.removeEventListener("scroll",a),window.addEventListener("scroll",a),a(),t.onclick=()=>{window.scrollTo({top:0,behavior:"smooth"})}}function H(){document.querySelectorAll(".lang-switch button[data-lang]").forEach(t=>{t.onclick=()=>{const a=t.dataset.lang;a!==S()&&(oe(a),K())}})}function V(){const t=document.getElementById("menu-toggle"),a=document.getElementById("nav-mobile");t==null||t.addEventListener("click",()=>{const n=a.classList.toggle("open");t.setAttribute("aria-expanded",n?"true":"false")}),a==null||a.querySelectorAll("a").forEach(n=>{n.addEventListener("click",()=>a.classList.remove("open"))})}const le={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},ue={...le,...pe,...he},de={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},ge={...de,...ce,...me},X=[{slug:"stoku-faturat-dhe-skanimi-me-ai",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku, Faturat dhe Skanimi me AI: Kontroll më i Lehtë për Restorantin",date:"06 maj 2026"},en:{category:"MANAGEMENT",title:"Inventory, Invoices & AI Scanning: Easier Control for Your Restaurant",date:"06 May 2026"}},{slug:"aplikacion-offline-me-sync",variant:"mobile",sq:{category:"POS & TEKNOLOGJI",title:"Aplikacion Offline me Sync për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Offline App with Sync for Restaurants",date:"06 May 2026"}},{slug:"program-pos-falas",variant:"pos",sq:{category:"POS & TEKNOLOGJI",title:"Program POS Falas për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Free POS Software for Restaurants",date:"06 May 2026"}},{slug:"5-arsye-pos",variant:"analytics",sq:{category:"MENAXHIM",title:"5 Arsye pse çdo restorant ka nevojë për POS",date:"05 maj 2026"},en:{category:"MANAGEMENT",title:"5 Reasons Every Restaurant Needs a POS System",date:"05 May 2026"}},{slug:"porosite-klienteve",variant:"mobile",sq:{category:"FUNKSIONALITETE",title:"Porositë e Klientëve: Klientët porosisin direkt nga telefoni",date:"04 maj 2026"},en:{category:"FEATURES",title:"Customer Orders: Guests Order Directly from Their Phone",date:"04 May 2026"}},{slug:"meny-digjitale-qr",variant:"qr",sq:{category:"TEKNOLOGJI",title:"Meny Digjitale me QR Code",date:"03 maj 2026"},en:{category:"TECHNOLOGY",title:"Digital Menu with QR Code",date:"03 May 2026"}},{slug:"skanoni-menyne-me-ai",variant:"scan",sq:{category:"TEKNOLOGJI",title:"Skanoni Menunë me AI: Shtoni 50 Produkte në 2 Minuta",date:"28 mars 2026"},en:{category:"TECHNOLOGY",title:"Scan Your Menu with AI: Add 50 Products in 2 Minutes",date:"28 March 2026"}},{slug:"stoku-menaxhimi-inventarit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku: Si të Menaxhoni Inventarin e Restorantit pa Humbje",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Inventory: How to Manage Restaurant Stock Without Losses",date:"28 March 2026"}},{slug:"zbritjet-ne-restorante",variant:"pos",sq:{category:"MENAXHIM",title:"Zbritjet në Restorante: Si të Rrisni Shitjet me Oferta të Zgjuara",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Discounts: Grow Sales with Smart Offers",date:"28 March 2026"}},{slug:"analitika-ne-restorante",variant:"analytics",sq:{category:"ANALITIKË",title:"Analitika në Restorante: Nga të Dhënat te Vendime më të Mira",date:"27 mars 2026"},en:{category:"ANALYTICS",title:"Restaurant Analytics: From Data to Better Decisions",date:"27 March 2026"}},{slug:"bashko-tavolina",variant:"tables",sq:{category:"VEÇORI",title:"Bashko Tavolina: Si të Kombinosh Porositë pa Ndërprerje",date:"27 mars 2026"},en:{category:"FEATURES",title:"Merge Tables: Combine Orders Without Disruption",date:"27 March 2026"}},{slug:"identifikim-stafi",variant:"login",sq:{category:"VEÇORI",title:"Identifikim Stafi: PIN, RFID apo Fjalëkalim — Cila Metodë për Çfarë?",date:"27 mars 2026"},en:{category:"FEATURES",title:"Staff Login: PIN, RFID or Password — Which Method for What?",date:"27 March 2026"}},{slug:"raportet-e-restorantit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Raportet e Restorantit: Si të Kuptosh Biznesin Tënd me Numra",date:"27 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Reports: Understand Your Business by the Numbers",date:"27 March 2026"}}];function ke(t){return t==="en"?ge:ue}function Y(t,a){const n=t[a]??t.sq,i=ke(a)[t.slug];return i?{slug:t.slug,variant:t.variant,category:n.category,title:n.title,date:n.date,content:i}:null}function fe(t,a=S()){const n=X.find(i=>i.slug===t);return n?Y(n,a):null}function ve(t=S()){return X.map(a=>Y(a,t)).filter(Boolean)}const ye=R("images/articles/program-pos-falas.jpg");function be(t){return R(`images/articles/${t}.jpg`)}function _(t,{alt:a="",loading:n="lazy",className:i="article-photo"}={}){const o=a.replace(/"/g,"&quot;");return`<img src="${be(t)}" alt="${o}" class="${i}" loading="${n}" onerror="this.onerror=null;this.src='${ye}';" />`}const je=R("images/hero.jpg"),Z=["p1","p2","p3","p4"],J={p1:["incl","f1","f2","f3","f4","f5","f6"],p2:["incl","f1","f2","f3","f4","f5","f6"],p3:["incl","f1","f2","f3","f4","f5","f6"],p4:["incl","f1","f2","f3","f4","f5","f6"]},we={p1:["incl","f1","f2","f3","f4"],p2:["incl","f1","f2","f3","f4"],p3:["incl","f1","f2","f3","f4"],p4:["incl","f1","f2","f3","f4"]};function ee(t,{keys:a}={}){const n=`packages.${t}`;return(a??J[t]??[]).map(o=>e(`${n}.${o}`)).filter(Boolean).map(o=>`<li>${o}</li>`).join("")}function I(t){const a=`packages.${t}`,n=e(`${a}.tagline`),i=e(`${a}.name`);return`
    <article
      ...
      aria-label="${i}"
    >
      <div class="package-card-thumb" aria-hidden="true">${i.charAt(0)}</div>
      <span class="package-badge">${e("packages.badge")}</span>
      <div class="package-card-body">
        <h3 class="package-name">${i}</h3>
        ${n?`<p class="package-tagline">${n}</p>`:""}
        <ul class="package-list">${ee(t,{keys:we[t]})}</ul>
        <span class="btn btn-ghost package-select-btn">${e(t==="p4"?"cta.contactAi":"cta.buyPackage")}</span>
      </div>
    </article>
  `}function T(t,a,n,i){const o=e(a);return`
    <article class="how-card">
      <div class="how-card-photo">
        <img src="${R(t)}" alt="${o}" loading="lazy" />
      </div>
      <div class="how-card-body">
        <h3>${o}</h3>
        <div class="how-card-desc-wrap">
          <p class="how-card-desc">${e(n)}</p>
        </div>
        <a class="how-card-link" href="${i}">${e("how.readManual")}</a>
      </div>
    </article>
  `}function Se(t){return`
    ...
    </div>`}function Pe({variant:t,categoryKey:a,titleKey:n,descKey:i,linkKey:o,href:r,imageSlug:s="",hidePhoto:h=!1}){const l=s?`<div class="spotlight-photo-fallback">${_(s,{className:"spotlight-img"})}</div>`:"",u=h?"":`
      <div class="spotlight-photo">
        ${Se()}
        ${l}
      </div>`;return`
    <a class="spotlight-card spotlight-card-${t}${h?" spotlight-card--no-photo":""}" href="${r}" data-navigate>
      ${u}
      <div class="spotlight-body">
        <div class="spotlight-category">${e(a)}</div>
        <h3 class="spotlight-title">${e(n)}</h3>
        <p class="spotlight-desc">${e(i)}</p>
        <span class="spotlight-link">${e(o)}</span>
      </div>
    </a>
  `}function Re(){const t=window.matchMedia("(max-width: 640px)");document.querySelectorAll(".how-card").forEach(a=>{const n=a.querySelector(".how-card-desc-wrap"),i=a.querySelector(".how-card-desc");if(!n||!i)return;let o=a.querySelector(".card-toggle[data-how-toggle]");o||(o=document.createElement("button"),o.type="button",o.className="card-toggle",o.dataset.howToggle="1",n.insertAdjacentElement("afterend",o));const r=()=>{const s=n.classList.contains("is-expanded"),h=t.matches&&(s||i.textContent.trim().length>85);o.hidden=!h,o.setAttribute("aria-expanded",s?"true":"false"),o.textContent=e(s?"expand.less":"expand.more"),t.matches||n.classList.remove("is-expanded")};o.addEventListener("click",()=>{n.classList.toggle("is-expanded"),r()}),r(),t.addEventListener("change",r),window.addEventListener("resize",r,{passive:!0})}),document.querySelectorAll(".package-card[data-package]").forEach(a=>{const n=a.querySelector(".package-list");if(!n)return;n.classList.add("package-list--foldable");let i=a.querySelector(".card-toggle[data-package-toggle]");i||(i=document.createElement("button"),i.type="button",i.className="card-toggle",i.dataset.packageToggle="1",n.insertAdjacentElement("afterend",i));const o=()=>{const r=n.querySelectorAll("li"),s=n.classList.contains("is-expanded"),h=t.matches&&r.length>3;i.hidden=!h,i.setAttribute("aria-expanded",s?"true":"false"),i.textContent=e(s?"expand.less":"expand.more"),t.matches||n.classList.remove("is-expanded")};i.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),n.classList.toggle("is-expanded"),o()}),o(),t.addEventListener("change",o)})}function Ae(){fetch("/api/public/config").then(i=>i.json()).then(i=>{i!=null&&i.ok&&i.stripe_enabled&&(window.__stripeEnabled=!0)}).catch(()=>{});const t=new URLSearchParams(window.location.hash.split("?")[1]||""),a=t.get("payment"),n=t.get("session_id");if(a==="success"){const i=document.querySelector(".get-started-note");i&&(i.textContent=e("checkout.success"),i.style.color="#15803d"),n&&n.startsWith("cs_")&&fetch("/api/payments/confirm-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({session_id:n})}).catch(()=>{})}}function z(t){const a=t&&Z.includes(t)?t:"";return a?`/api/public/setup-download?plan=${encodeURIComponent(a)}`:"/api/public/setup-download"}function qe(){const t=document.getElementById("get-started-download"),a=document.getElementById("get-started-wa");t&&(t.href=z(sessionStorage.getItem("selectedPackage")||"p1")),a&&(async()=>{try{const n=await fetch("/api/public/config"),i=await n.json();if(!n.ok||!i.ok)return;const o=i.support_phone_digits||"38348707880",r=encodeURIComponent(S()==="en"?"Hello, I downloaded Setup — I need a trial / license key.":"Përshëndetje, shkarkova Setup — më duhet çelës trial / licencë.");a.href=`https://wa.me/${o}?text=${r}`,i.setup_download_url&&t&&!sessionStorage.getItem("selectedPackage")&&(t.href=i.setup_download_url)}catch{}})()}function ze(){const t=document.getElementById("pay-stripe-cta"),a=document.querySelectorAll("[data-pay-bank]");a.forEach(n=>{n.addEventListener("click",i=>{var h;i.preventDefault(),a.forEach(l=>l.classList.remove("is-selected")),n.classList.add("is-selected");const o=document.getElementById("pay-hint"),r=n.dataset.payBank||"raiffeisen",s=sessionStorage.getItem("selectedPackage")||"";if(s==="p4"){o&&(o.hidden=!1,o.textContent=e("packages.p4.summary"));return}if(s==="p1"||s==="p2"||s==="p3"){Me(s,r);return}o&&(o.hidden=!1,o.textContent=e("pay.pickPlan")),(h=document.getElementById("pakot"))==null||h.scrollIntoView({behavior:"smooth"})})}),t==null||t.addEventListener("click",()=>{var o;const n=sessionStorage.getItem("selectedPackage")||"",i=document.getElementById("pay-hint");if(n==="p4"){i&&(i.hidden=!1,i.textContent=e("packages.p4.summary"));return}if(n==="p1"||n==="p2"||n==="p3"){window.__stripeEnabled?te(n):i&&(i.hidden=!1,i.textContent=e("checkout.error"));return}i&&(i.hidden=!1,i.textContent=e("pay.pickPlan")),(o=document.getElementById("pakot"))==null||o.scrollIntoView({behavior:"smooth"})})}function Oe(){var b;const t=document.querySelectorAll(".package-card[data-package]"),a=document.getElementById("package-detail"),n=document.getElementById("package-detail-name"),i=document.getElementById("package-detail-summary"),o=document.getElementById("package-detail-list"),r=document.getElementById("contact-package"),s=document.getElementById("packages-one-only");if(!t.length||!a)return;let h=null;const l=()=>{h=null,sessionStorage.removeItem("selectedPackage"),t.forEach(p=>{p.classList.remove("selected"),p.setAttribute("aria-pressed","false")}),a.hidden=!0,r&&(r.value=""),s&&(s.hidden=!0)},u=(p,y={})=>{const f=!!y.force;if(!f&&h&&h!==p){s&&(s.hidden=!1,s.textContent=e("packages.oneOnly"));return}if(!f&&h===p){l();return}const d=`packages.${p}`;if(h=p,t.forEach(c=>{const j=c.dataset.package===p;c.classList.toggle("selected",j),c.setAttribute("aria-pressed",j?"true":"false")}),n.textContent=e(`${d}.name`),i){const c=e(`${d}.summary`);i.textContent=c,i.hidden=!c}o.innerHTML=ee(p,{keys:J[p]}),a.hidden=!1,s&&(s.hidden=!1,s.textContent=e("packages.oneOnly")),r&&(r.value=e(`${d}.name`));const m=document.getElementById("package-detail-cta");m&&(p==="p4"?m.textContent=e("cta.contactAi"):window.__stripeEnabled?m.textContent=e("cta.payStripe"):m.textContent=e("cta.buyPackage"));const v=document.getElementById("package-detail-download");v&&(v.href=z(p),v.hidden=!1);const g=document.getElementById("get-started-download");g&&(g.href=z(p)),sessionStorage.setItem("selectedPackage",p)};t.forEach(p=>{const y=p.dataset.package,f=d=>{var m;(m=d==null?void 0:d.target)!=null&&m.closest(".how-card-link")||u(y)};p.addEventListener("click",f),p.addEventListener("keydown",d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),u(y))})}),(b=document.getElementById("package-detail-cta"))==null||b.addEventListener("click",async()=>{var m,v;const p=sessionStorage.getItem("selectedPackage")||"",y=((m=document.getElementById("contact-package"))==null?void 0:m.value.trim())||"";let f="38348707880",d=!!window.__stripeEnabled;try{const g=await fetch("/api/public/config"),c=await g.json();g.ok&&c.ok&&(c.support_phone_digits&&(f=c.support_phone_digits),c.stripe_enabled&&(d=!0,window.__stripeEnabled=!0))}catch{}if(p==="p4"){const g=`Përshëndetje, dua informacion për AI (Pako 4).
Pako: ${y}`;window.open(`https://wa.me/${f}?text=${encodeURIComponent(g)}`,"_blank","noopener,noreferrer");return}if(d&&(p==="p1"||p==="p2"||p==="p3")){(v=document.getElementById("pagesa"))==null||v.scrollIntoView({behavior:"smooth"}),te(p);return}window.location.href=z(p||"p1")});const k=sessionStorage.getItem("selectedPackage");k&&Z.includes(k)&&u(k,{force:!0})}async function Ie(){var h;const t=document.getElementById("trial-modal");t&&t.remove();let a="+383 48707880",n="38348707880";try{const l=await fetch("/api/public/config"),u=await l.json();l.ok&&u.ok&&(u.support_phone&&(a=u.support_phone),u.support_phone_digits&&(n=u.support_phone_digits))}catch{}const i=encodeURIComponent(e("wa.trial")),o=sessionStorage.getItem("selectedPackage")||"p1",r=document.createElement("div");r.id="trial-modal",r.className="checkout-modal",r.innerHTML=`
    <div class="checkout-modal-card" role="dialog" aria-modal="true" aria-labelledby="trial-title">
      ...
      <div class="checkout-actions">
        <a class="btn btn-primary" href="${z(o)}" download>${e("trialModal.download")}</a>
        <a class="btn btn-ghost" href="https://wa.me/${n}?text=${i}" target="_blank" rel="noopener noreferrer">${e("trialModal.wa")}</a>
        <button type="button" class="btn btn-ghost" id="trial-close">${e("trialModal.close")}</button>
      </div>
    </div>`,document.body.appendChild(r);const s=()=>r.remove();(h=r.querySelector("#trial-close"))==null||h.addEventListener("click",s),r.addEventListener("click",l=>{l.target===r&&s()})}function Te(){document.querySelectorAll("[data-trial-modal]").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),Ie()})})}const q={company:"REVOLUTION INVEST SH.P.K.",bank:"Raiffeisen Bank Kosovo",account:"1504001010467891",currency:"EUR",nui:"811314567"};async function Ke(){try{const t=await fetch("/api/payments/bank-transfer"),a=await t.json();if(t.ok&&a.ok&&a.account)return{company:a.company||q.company,bank:a.bank||q.bank,account:a.account,currency:a.currency||q.currency,nui:a.nui||q.nui}}catch{}return{...q}}function Me(t,a){var s,h;const n=document.getElementById("bank-transfer-modal");n&&n.remove();const i=document.createElement("div");i.id="bank-transfer-modal",i.className="checkout-modal",i.innerHTML=`
    <div class="checkout-modal-card checkout-modal-card-wide" role="dialog" aria-modal="true" aria-labelledby="bank-title">
    ...
    </div>`,document.body.appendChild(i);const o=()=>i.remove();(s=i.querySelector("#bk-cancel"))==null||s.addEventListener("click",o),i.addEventListener("click",l=>{l.target===i&&o()});const r=i.querySelector("#bank-details");Ke().then(l=>{var u;r&&(r.removeAttribute("aria-busy"),r.innerHTML=`
      ...
      <button type="button" class="btn btn-ghost bank-copy-btn" id="bk-copy">${e("bank.copy")}</button>`,(u=i.querySelector("#bk-copy"))==null||u.addEventListener("click",async()=>{const k=i.querySelector("#bk-copy");try{await navigator.clipboard.writeText(l.account),k&&(k.textContent=e("bank.copied"))}catch{}}))}),(h=i.querySelector("#bk-submit"))==null||h.addEventListener("click",async()=>{var d,m,v,g,c;const l=i.querySelector("#bk-submit"),u=i.querySelector("#bk-msg"),k=String(((d=i.querySelector("#bk-emri"))==null?void 0:d.value)||"").trim(),b=String(((m=i.querySelector("#bk-biz"))==null?void 0:m.value)||"").trim(),p=String(((v=i.querySelector("#bk-email"))==null?void 0:v.value)||"").trim(),y=String(((g=i.querySelector("#bk-phone"))==null?void 0:g.value)||"").trim(),f=String(((c=i.querySelector("#bk-tipi"))==null?void 0:c.value)||"restorant");if(!k||!b||!p){u&&(u.hidden=!1,u.textContent=e("bank.error"));return}l&&(l.disabled=!0,l.textContent=e("bank.busy"));try{const j=await fetch("/api/payments/bank-transfer/request",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plan:t,bank:a,emri:k,emri_biznesit:b,email:p,telefoni:y,tipi:f})}),E=await j.json();if(!j.ok||!E.ok)throw new Error(E.gabim||e("bank.error"));u&&(u.hidden=!1,u.classList.add("checkout-msg-ok"),u.textContent=E.message||e("bank.success")),l&&(l.disabled=!0,l.textContent=e("bank.submit"))}catch(j){u&&(u.hidden=!1,u.textContent=j.message||e("bank.error")),l&&(l.disabled=!1,l.textContent=e("bank.submit"))}})}function te(t){var o,r;const a=document.getElementById("stripe-checkout-modal");a&&a.remove();const n=document.createElement("div");n.id="stripe-checkout-modal",n.className="checkout-modal",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n);const i=()=>n.remove();(o=n.querySelector("#co-cancel"))==null||o.addEventListener("click",i),n.addEventListener("click",s=>{s.target===n&&i()}),(r=n.querySelector("#co-pay"))==null||r.addEventListener("click",async()=>{var y,f,d,m,v;const s=n.querySelector("#co-pay"),h=n.querySelector("#co-msg"),l=String(((y=n.querySelector("#co-emri"))==null?void 0:y.value)||"").trim(),u=String(((f=n.querySelector("#co-biz"))==null?void 0:f.value)||"").trim(),k=String(((d=n.querySelector("#co-email"))==null?void 0:d.value)||"").trim(),b=String(((m=n.querySelector("#co-phone"))==null?void 0:m.value)||"").trim(),p=String(((v=n.querySelector("#co-tipi"))==null?void 0:v.value)||"restorant");if(!l||!u||!k){h&&(h.hidden=!1,h.textContent=e("checkout.error"));return}s&&(s.disabled=!0,s.textContent=e("checkout.busy"));try{const g=await fetch("/api/payments/checkout",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({plan:t,emri:l,emri_biznesit:u,email:k,telefoni:b,tipi:p})}),c=await g.json();if(!g.ok||!c.ok||!c.url)throw new Error(c.gabim||e("checkout.error"));window.location.href=c.url}catch(g){h&&(h.hidden=!1,h.textContent=g.message||e("checkout.error")),s&&(s.disabled=!1,s.textContent=e("checkout.pay"))}})}function G(){var n,i;const t=ve(),a=S();document.title=e("meta.title"),(i=document.querySelector('meta[name="description"]'))==null||i.setAttribute("content",((n=M[a])==null?void 0:n["meta.description"])??M.sq["meta.description"]),document.getElementById("app").innerHTML=`
    ${F({activeNav:"home"})}
    <main>
      <section class="hero hero-with-image hero-home" id="ballina" style="--hero-image: url('${je}')">
      ...
      <section class="site-section spotlight-section" id="veçorite">
        <div class="container">
          ...
          <div class="spotlight-grid spotlight-grid--single">
            ${Pe({variant:"platform",categoryKey:"spotlight.card2.category",titleKey:"spotlight.card2.title",descKey:"spotlight.card2.desc",linkKey:"spotlight.card2.link",href:"#pakot"})}
          </div>
        </div>
      </section>
      ...
      <section class="articles" id="artikuj">
        <div class="container">
          ...
          <div class="article-grid">
            ${t.map(o=>`
                  <a class="article-card" href="${se(o.slug)}" data-navigate>
                    <div class="article-thumb">
                      ${_(o.slug,{alt:o.title})}
                    </div>
      ...
      <section class="site-section" id="si-funksionon">
        <div class="container">
          ...
          <div class="how-grid">
            ${T("images/modules/pos-kasa.jpg","how.pos.title","how.pos.desc","/website/manual.html#menuja")}
            ${T("images/modules/kamarieri.jpg","how.waiter.title","how.waiter.desc","/website/manual.html#kamarieri")}
            ${T("images/modules/kds-kuzhina.jpg","how.kds.title","how.kds.desc","/website/manual.html#kuzhina")}
            ${T("images/modules/pronari.jpg","how.owner.title","how.owner.desc","/website/manual.html#hyrja")}
          </div>
        </div>
      </section>
    ...
    ${L()}
    ${W()}
  `,B(),H(),V(),D(),Oe(),Re(),qe(),ze(),Te(),Ae(),window.location.hash?requestAnimationFrame(()=>{var o;(o=document.querySelector(window.location.hash))==null||o.scrollIntoView({behavior:"smooth"})}):window.scrollTo(0,0)}function $e(t){const a=fe(t);if(!a){G();return}document.title=`${a.title} — Revolution POS`,document.getElementById("app").innerHTML=`
    ${F({activeNav:"blog"})}
    <main class="article-page">
      <div class="container">
        <a class="article-back" href="${x()}" data-navigate>${e("backToBlog")}</a>
        ...
        <article class="article-full">
          ...
          <div class="article-full-image">
            ${_(a.slug,{alt:a.title,loading:"eager"})}
          </div>
    ...
    ${L()}
    ${W()}
  `,B(),H(),V(),D(),window.scrollTo(0,0)}const xe={privacy:{sq:{title:"Privatësia e të dhënave",updated:"Përditësuar: qershor 2026",content:`
      ...
      `}}};function Ee(t){const a=xe[t];if(!a)return null;const n=S();return a[n]??a.sq}function ae(t){const a=Ee(t);if(!a){G();return}document.title=`${a.title} — Revolution Invest POS`,document.getElementById("app").innerHTML=`
    ${F({activeNav:"home"})}
    <main class="legal-page">
      <div class="container">
        <a class="article-back" href="${x()}" data-navigate>${e("legal.backHome")}</a>
    ...
    ${L()}
    ${W()}
  `,B(),H(),V(),D(),window.scrollTo(0,0)}$("/",()=>G());$("/privacy",()=>ae("privacy"));$("/terms",()=>ae("terms"));$("/blog/:slug",({slug:t})=>$e(t));ne();
