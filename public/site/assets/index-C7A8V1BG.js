...
`:"");window.location.href=`mailto:${i("contact.email")}?subject=${d}&body=${u}`});const p=sessionStorage.getItem("selectedPackage");p&&pe.includes(p)&&s(p)}function $(){var a,n;const e=re(),t=g();document.title=i("meta.title"),(n=document.querySelector('meta[name="description"]'))==null||n.setAttribute("content",((a=P[t])==null?void 0:a["meta.description"])??P.sq["meta.description"]),document.getElementById("app").innerHTML=`
    ...
    <main>
      ...
      <section class="highlight-band" id="librat-kontabilistit" aria-labelledby="accounting-title">
        <div class="container">
          <div class="highlight-panel">
            <div class="highlight-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5V6.2c0-.7.5-1.2 1.2-1.2H14v14.5H5.2c-.7 0-1.2-.5-1.2-1.2Z"/><path d="M14 5h4.8c.7 0 1.2.5 1.2 1.2v13.3c0 .7-.5 1.2-1.2 1.2H14V5Z"/><path d="M7.5 9h4M7.5 12.5h4M7.5 16h2.5"/></svg>
            </div>
            <div class="highlight-copy">
              <h2 id="accounting-title">${i("accounting.title")}</h2>
              <p>${i("accounting.desc")}</p>
            </div>
          </div>
        </div>
      </section>
