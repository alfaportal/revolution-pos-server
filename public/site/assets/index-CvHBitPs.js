(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const O=[];function R(e,t){const a=[],o=new RegExp("^"+e.replace(/\//g,"\\/").replace(/:([a-zA-Z]+)/g,(n,r)=>(a.push(r),"([^/]+)"))+"$");O.push({regex:o,keys:a,handler:t})}function G(e){const t=e.indexOf("#"),a=t>=0?e.slice(t+1):"",o=t>=0?e.slice(0,t)||"/":e;window.history.pushState({},"",a?`${o}#${a}`:o),P(),a&&requestAnimationFrame(()=>{var n;(n=document.getElementById(a))==null||n.scrollIntoView({behavior:"smooth"})})}function g(){return window.location.pathname.replace(/\/+$/,"")||"/"}function P(){var t;const e=g();for(const a of O){const o=e.match(a.regex);if(!o)continue;const n={};a.keys.forEach((r,s)=>{n[r]=decodeURIComponent(o[s+1])}),a.handler(n);return}(t=O.find(a=>a.regex.source==="^\\/$"))==null||t.handler({})}function Q(){document.addEventListener("click",e=>{const t=e.target.closest("a[data-navigate]");t&&(e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),G(t.getAttribute("href"))))}),window.addEventListener("popstate",P),P()}const F={sq:{navLabel:"Kryesore",langLabel:"Gjuha",features:"Veçoritë",howItWorks:"Si funksionon",packages:"Paketat",faq:"FAQ",blog:"Blog",backToTop:"Kthehu lart",blogBadge:"Blog",heroTitle:"Këshilla & Njohuri për",heroAccent:"Restorante Moderne",heroSubtitle:"Artikuj praktikë për menaxhimin e restorantit, teknologjinë POS dhe eficiencën operacionale.",readMore:"Lexo →",backToBlog:"← Kthehu në ballina",pageTitle:"Revolution Invest POS — Restorante & Kafene",metaDescription:"Këshilla dhe njohuri për restorante moderne — menaxhim, POS, teknologji dhe eficiencë operacionale."},en:{navLabel:"Main navigation",langLabel:"Language",features:"Features",howItWorks:"How it works",packages:"Pricing",faq:"FAQ",blog:"Blog",backToTop:"Back to top",blogBadge:"Blog",heroTitle:"Tips & Insights for",heroAccent:"Modern Restaurants",heroSubtitle:"Practical articles on restaurant management, POS technology, and operational efficiency.",readMore:"Read →",backToBlog:"← Back to home",pageTitle:"Revolution Invest POS — Restaurants & Cafés",metaDescription:"Tips and insights for modern restaurants — management, POS, technology, and operational efficiency."}},S={sq:{"meta.title":"Revolution Invest POS — Sistemi POS për Restorantet dhe Kafenetë","meta.description":"Revolution Invest POS — sistemi i plotë për restorante dhe kafene. POS, KDS, kamarier, kiosk, raporte dhe faqe publike.","brand.subtitle":"Restorant & Kafene","nav.home":"Ballina","nav.howItWorks":"Si funksionon","nav.packages":"Pakot","nav.blog":"Blog","nav.manual":"Manuali","nav.contact":"Kontakti","nav.openMenu":"Hap menunë","cta.startFree":"Fillo Falas","cta.choosePackage":"Zgjidh Pakon","cta.contactUs":"Na Kontaktoni","cta.sendRequest":"Dërgo kërkesën","hero.badge":"Provë Falas 1 Muaj","hero.title":"Kontrollo çdo Porosi. Çdo Tavolinë. Çdo Ditë.","hero.subtitle":"Sistemi POS që punon për ty — nga kasa te kuzhina, nga kamarieri te pronari. Gjithçka në një platformë.","hero.cta.primary":"Fillo 1 Muaj Falas","hero.cta.secondary":"Shiko si funksionon →","hero.stats.restaurants":"500+ Restorante","hero.stats.support":"24/7 Mbështetje","hero.stats.cloud":"Cloud & Offline","how.title":"Si funksionon sistemi","how.subtitle":"Çdo modul ka rolin e vet — së bashku mbulojnë operimin e plotë të restorantit, nga porosia deri te raporti.","how.pos.title":"POS Kasa","how.pos.desc":"Merr porosi, bëj fatura fiskale dhe menaxho tavolinat — qendra e operimit të restorantit tuaj.","how.waiter.title":"Kamarieri","how.waiter.desc":"Tablet ose telefon — merr porosi direkt nga tavolina dhe i dërgon automatikisht në kuzhinë.","how.kds.title":"KDS Kuzhina","how.kds.desc":"Ekran dixhital — sheh porositë në kohë reale dhe konfirmon kur pjata është gati për servim.","how.owner.title":"Pronari","how.owner.desc":"Panel online — sheh raportet, menaxhon menunë dhe stafin nga kudo, edhe nga telefoni.","how.readManual":"Lexo në manual →","packages.title":"Pakot fleksibile për çdo madhësi biznesi","packages.subtitle":"Nga kafene e vogla deri te restorant me shumë lokale — zgjidh paketën që përshtatet me ty. Çdo nivel shton module mbi bazën e mëparshme; nuk paguan për gjëra që nuk i përdor. Të gjitha pakot fillojnë me 1 muaj provë falas.","packages.badge":"1 muaj falas","packages.perWeek":"/javë","packages.p1.name":"Pako 1 — Fillore","packages.p1.tagline":"Fillim i thjeshtë për kafene & restorante të vogla","packages.p1.summary":"Kasa digjitale, panel pronari, faqe publike me menu dhe raporte ditore — mjaftueshëm për të digitalizuar shitjet pa kompleksitet.","packages.p1.f1":"POS Kasa — shitje, pagesa & fatura termike","packages.p1.f2":"Panel pronari — menu, çmime, kategori & stafi","packages.p1.f3":"Faqja publike — menu digjitale & info lokali (pa porosi online)","packages.p1.f4":"Raportet & Z-Report — mbyllje ditor & arkë","packages.p1.f5":"Printim fatura — termik & format A4","packages.p1.f6":"1 muaj provë falas — aktivizo pa pagesë","packages.p2.name":"Pako 2 — Në rritje","packages.p2.tagline":"Kuzhina e lidhur & porosi direkt nga tavolina","packages.p2.summary":"Për lokale me kuzhinë aktive: porositë shkojnë live te ekrani i kuzhinës, klienti skanon QR-në e tavolinës dhe kamarieri merr porosi me tablet.","packages.p2.incl":"Përfshin të gjitha nga Pako Fillore","packages.p2.f1":"KDS Kuzhina — porosi live te ekrani i kuzhinës","packages.p2.f2":"Kiosk QR — klienti skanon & porosit nga tavolina","packages.p2.f3":"Terminal kamarier — merr porosi me tablet ose telefon","packages.p2.f4":"Menaxhim tavolinash — zona, numra & status","packages.p2.f5":"Sinkronizim kuzhinë–kasë në kohë reale","packages.p2.f6":"Faqe publike me menu interaktive për klientët","packages.p3.name":"Pako 3 — Profesionale","packages.p3.tagline":"Mobile, cloud & kontroll i plotë i operacioneve","packages.p3.summary":"Për ekipa më të mëdha: aplikacion mobile për stafin, menaxhim pajisjesh, backup në cloud dhe raporte të thelluara për vendime më të mira.","packages.p3.incl":"Përfshin të gjitha nga Pako në Rritje","packages.p3.f1":"Aplikacion mobile — stafi punon nga telefoni","packages.p3.f2":"Menaxhim telefonash & pajisjeve të autorizuara","packages.p3.f3":"Backup cloud & përditësime automatike të sistemit","packages.p3.f4":"Raporte të avancuara — shitje, orare & performancë","packages.p3.f5":"Multi-përdorues — role & leje të detajuara për stafin","packages.p3.f6":"Mbështetje prioritet & onboarding i dedikuar","packages.p4.name":"Pako 4 — Premium","packages.p4.tagline":"Porosi online & prezencë digjitale e plotë","packages.p4.summary":"Paketa më e plotë: klientët porositin dhe paguajnë online, faqja publike me cover, galeri, oferta, vlerësime dhe lidhje sociale — plus inventar dhe multi-lokal.","packages.p4.incl":"Përfshin të gjitha nga Pako Profesionale","packages.p4.f1":"Porosi online — klienti porosit & paguan nga faqja publike","packages.p4.f2":"Faqe premium — cover, galeri foto & oferta e ditës","packages.p4.f3":"Vlerësime klientësh — reputacion & feedback publik","packages.p4.f4":"WhatsApp, Instagram, Facebook & TikTok — një klik kontakt","packages.p4.f5":"Inventar & stok — alarme, hyrje/dalje & raporte","packages.p4.f6":"Multi-lokal — menaxhim & raporte të konsoliduara","packages.clickHint":"Klikoni një paketë për të parë çfarë përfshin","packages.includes":"Çfarë përfshin kjo paketë:","packages.selected":"Zgjedhur","contact.title":"Filloni sot — provë 1 muaj falas","contact.subtitle":"Na kontaktoni për instalim, demo live dhe zgjedhjen e pakos së duhur për restorantin ose kafenen tuaj.","contact.direct":"Kontakt i drejtpërdrejtë","contact.sendMessage":"Dërgo mesazh","form.name":"Emri","form.phone":"Telefoni","form.message":"Mesazhi","form.namePlaceholder":"Emri i biznesit","form.messagePlaceholder":"P.sh. Restorant me 15 tavolina në Prishtinë…","form.error":"Plotësoni të gjitha fushat.","form.success":"Faleminderit! Po ju hapim WhatsApp për të dërguar kërkesën.","footer.tagline":"Sistemi i plotë POS për restorante, kafene dhe bare — porosi, kuzhinë, raporte dhe menaxhim nga një vend i vetëm.","footer.note":"Zhvilluar dhe mirëmbajtur nga ekipi ynë në Kosovë dhe rajon.","footer.col.platform":"Platforma","footer.col.support":"Ndihmë & kontakt","footer.link.howItWorks":"Si funksionon","footer.link.packages":"Pakot & modulet","footer.link.blog":"Artikuj & këshilla","footer.link.manual":"Manuali i përdorimit","footer.link.contact":"Na kontaktoni","footer.link.login":"Hyr në panel pronari","footer.link.trial":"Fillo provën falas","footer.legal.privacy":"Privatësia e të dhënave","footer.legal.terms":"Kushtet e shërbimit","footer.legal.notice":"Revolution Invest POS ofrohet me licencë të rregullt. Të dhënat e biznesit tuaj ruhen në mënyrë të sigurt sipas politikës sonë të privatësisë.","footer.rights":"Revolution Invest. Të gjitha të drejtat e rezervuara.","wa.trial":"Përshëndetje, dëshiroj të provoj Revolution Invest POS.","wa.custom":"Përshëndetje, dëshiroj të diskutoj për zgjidhje të personalizuara.","wa.formIntro":"Përshëndetje, jam {name} ({phone}).","wa.formSuffix":"Dëshiroj Revolution Invest POS — 1 muaj falas.","legal.backHome":"← Kthehu në ballina","articles.heading":"Artikujt e fundit"},en:{"meta.title":"Revolution Invest POS — POS System for Restaurants & Cafés","meta.description":"Revolution Invest POS — the complete system for restaurants and cafés. POS, KDS, waiter, kiosk, reports, and public page.","brand.subtitle":"Restaurant & Café","nav.home":"Home","nav.howItWorks":"How it works","nav.packages":"Pricing","nav.blog":"Blog","nav.manual":"Manual","nav.contact":"Contact","nav.openMenu":"Open menu","cta.startFree":"Start Free","cta.choosePackage":"Choose Plan","cta.contactUs":"Contact Us","cta.sendRequest":"Send request","hero.badge":"1 Month Free Trial","hero.title":"Control Every Order. Every Table. Every Day.","hero.subtitle":"The POS system that works for you — from register to kitchen, waiter to owner. Everything in one platform.","hero.cta.primary":"Start 1 Month Free","hero.cta.secondary":"See how it works →","hero.stats.restaurants":"500+ Restaurants","hero.stats.support":"24/7 Support","hero.stats.cloud":"Cloud & Offline","how.title":"How the system works","how.subtitle":"Each module has its role — together they cover full restaurant operations, from order to report.","how.pos.title":"POS Register","how.pos.desc":"Take orders, issue fiscal invoices, and manage tables — the hub of your restaurant operations.","how.waiter.title":"Waiter","how.waiter.desc":"Tablet or phone — take orders directly from the table and send them automatically to the kitchen.","how.kds.title":"Kitchen KDS","how.kds.desc":"Digital screen — see orders in real time and confirm when a dish is ready to serve.","how.owner.title":"Owner","how.owner.desc":"Online panel — view reports, manage menu and staff from anywhere, even your phone.","how.readManual":"Read in manual →","packages.title":"Flexible plans for every business size","packages.subtitle":"From a small café to a multi-location restaurant — pick the tier that fits. Each level adds modules on top of the previous one. Every plan starts with a 1-month free trial.","packages.badge":"1 month free","packages.perWeek":"/week","packages.p1.name":"Plan 1 — Starter","packages.p1.tagline":"Simple start for small cafés & restaurants","packages.p1.summary":"Digital register, owner panel, public menu page and daily reports — enough to digitize sales without complexity.","packages.p1.f1":"POS register — sales, payments & thermal receipts","packages.p1.f2":"Owner panel — menu, prices, categories & staff","packages.p1.f3":"Public page — digital menu & venue info (no online orders)","packages.p1.f4":"Reports & Z-Report — daily close & cash drawer","packages.p1.f5":"Receipt printing — thermal & A4 formats","packages.p1.f6":"1 month free trial — activate at no cost","packages.p2.name":"Plan 2 — Growing","packages.p2.tagline":"Connected kitchen & table-side ordering","packages.p2.summary":"For venues with an active kitchen: orders go live to the kitchen screen, guests scan the table QR, and waiters take orders on tablet.","packages.p2.incl":"Includes everything in Starter","packages.p2.f1":"Kitchen Display (KDS) — live orders on the kitchen screen","packages.p2.f2":"QR kiosk — guests scan & order from the table","packages.p2.f3":"Waiter terminal — take orders on tablet or phone","packages.p2.f4":"Table management — zones, numbers & live status","packages.p2.f5":"Real-time kitchen–register sync","packages.p2.f6":"Interactive public menu page for guests","packages.p3.name":"Plan 3 — Professional","packages.p3.tagline":"Mobile, cloud & full operational control","packages.p3.summary":"For larger teams: mobile app for staff, device management, cloud backup and in-depth reports for better decisions.","packages.p3.incl":"Includes everything in Growing","packages.p3.f1":"Mobile app — staff work from their phone","packages.p3.f2":"Phone & authorized device management","packages.p3.f3":"Cloud backup & automatic system updates","packages.p3.f4":"Advanced reports — sales, hours & performance","packages.p3.f5":"Multi-user — detailed roles & permissions","packages.p3.f6":"Priority support & dedicated onboarding","packages.p4.name":"Plan 4 — Premium","packages.p4.tagline":"Online orders & a complete digital presence","packages.p4.summary":"The full package: customers order and pay online, public page with cover, gallery, daily offers, reviews and social links — plus inventory and multi-location.","packages.p4.incl":"Includes everything in Professional","packages.p4.f1":"Online orders — customers order & pay on the public page","packages.p4.f2":"Premium page — cover photo, gallery & daily offers","packages.p4.f3":"Customer reviews — reputation & public feedback","packages.p4.f4":"WhatsApp, Instagram, Facebook & TikTok — one-click contact","packages.p4.f5":"Inventory & stock — alerts, in/out & reports","packages.p4.f6":"Multi-location — consolidated management & reports","packages.clickHint":"Click a plan to see what's included","packages.includes":"What's included in this plan:","packages.selected":"Selected","contact.title":"Start today — 1 month free trial","contact.subtitle":"Contact us for installation, a live demo, and choosing the right plan for your restaurant or café.","contact.direct":"Direct contact","contact.sendMessage":"Send a message","form.name":"Name","form.phone":"Phone","form.message":"Message","form.namePlaceholder":"Business name","form.messagePlaceholder":"E.g. Restaurant with 15 tables in Pristina…","form.error":"Please fill in all fields.","form.success":"Thank you! Opening WhatsApp so you can send your request.","footer.tagline":"The complete POS system for restaurants, cafés, and bars — orders, kitchen, reports, and management from one place.","footer.note":"Developed and maintained by our team in Kosovo and the region.","footer.col.platform":"Platform","footer.col.support":"Help & contact","footer.link.howItWorks":"How it works","footer.link.packages":"Plans & modules","footer.link.blog":"Articles & tips","footer.link.manual":"User manual","footer.link.contact":"Contact us","footer.link.login":"Owner panel login","footer.link.trial":"Start free trial","footer.legal.privacy":"Data privacy","footer.legal.terms":"Terms of service","footer.legal.notice":"Revolution Invest POS is provided under a standard license. Your business data is stored securely in line with our privacy policy.","footer.rights":"Revolution Invest. All rights reserved.","wa.trial":"Hello, I would like to try Revolution Invest POS.","wa.custom":"Hello, I would like to discuss a tailored solution.","wa.formIntro":"Hello, I'm {name} ({phone}).","wa.formSuffix":"I want Revolution Invest POS — 1 month free.","legal.backHome":"← Back to home","articles.heading":"Latest articles"}},E="revolution-pos-lang";let c=localStorage.getItem(E)||"sq";function k(){return c}function V(e){e!=="sq"&&e!=="en"||(c=e,localStorage.setItem(E,c),document.documentElement.lang=c==="en"?"en":"sq")}function i(e){var t,a;return((t=F[c])==null?void 0:t[e])??((a=S[c])==null?void 0:a[e])??F.sq[e]??S.sq[e]??e}document.documentElement.lang=c==="en"?"en":"sq";function z(){return"/"}function U(){return"/blog"}function Y(e){return`${U()}/${e}`.replace(/\/+/g,"/")}function f(e){return`/${e.replace(/^\//,"")}`}function q(e){return g()==="/"?`#${e}`:`/#${e}`}function y(e,t,a,o){const n=g()==="/";return`<a href="${q(e)}"${n?"":" data-navigate"} class="${a===o?"active":""}">${t}</a>`}function A({activeNav:e="home"}={}){const t=k(),a=[{id:"home",label:i("nav.home"),section:"ballina"},{id:"how-it-works",label:i("nav.howItWorks"),section:"si-funksionon"},{id:"packages",label:i("nav.packages"),section:"pakot"},{id:"blog",label:i("nav.blog"),section:"artikuj"}];return`
    <header class="site-header">
      <div class="container header-inner">
        ...
        <nav class="nav nav-desktop" aria-label="${i("navLabel")}">
          ${a.map(o=>y(o.section,o.label,e,o.id)).join("")}
  ...
  `}function j(e,t){const a=g()==="/";return`<li><a href="${a?`#${e}`:`/#${e}`}"${a?"":" data-navigate"}>${t}</a></li>`}function T(){const t=g()==="/"?"":" data-navigate";return`
  ...
  `}function I(){const e=document.getElementById("footer-whatsapp");if(!e)return;async function t(){try{const a=await fetch("/api/public/config"),o=await a.json();if(!a.ok||!o.ok)return;const n=o.support_phone||"+383 44 123 456",r=o.support_phone_digits||"38344123456";e.textContent=`WhatsApp — ${n}`,e.href=`https://wa.me/${r}?text=${encodeURIComponent(i("wa.trial"))}`}catch{e.textContent="WhatsApp",e.href=`https://wa.me/38344123456?text=${encodeURIComponent(i("wa.trial"))}`}}t()}function K(){return`<button id="back-to-top" class="back-to-top" type="button" aria-label="${i("backToTop")}">↑</button>`}function M(){const e=document.querySelector("#back-to-top");if(!e)return;const t=()=>{e.classList.toggle("visible",window.scrollY>400)};window.removeEventListener("scroll",t),window.addEventListener("scroll",t),t(),e.onclick=()=>{window.scrollTo({top:0,behavior:"smooth"})}}function x(){document.querySelectorAll(".lang-switch button[data-lang]").forEach(e=>{e.onclick=()=>{const t=e.dataset.lang;t!==k()&&(V(t),P())}})}function $(){const e=document.getElementById("menu-toggle"),t=document.getElementById("nav-mobile");e==null||e.addEventListener("click",()=>{const a=t.classList.toggle("open");e.setAttribute("aria-expanded",a?"true":"false")}),t==null||t.querySelectorAll("a").forEach(a=>{a.addEventListener("click",()=>t.classList.remove("open"))})}function Z(){const e=document.getElementById("contact-form"),t=document.getElementById("form-msg");if(!e)return;let a="38344123456",o="+383 44 123 456";async function n(){try{const r=await fetch("/api/public/config"),s=await r.json();if(!r.ok||!s.ok)return;s.support_phone&&(o=s.support_phone),s.support_phone_digits&&(a=s.support_phone_digits);const d=document.getElementById("contact-whatsapp-label"),m=document.getElementById("contact-tel-label"),l=document.getElementById("contact-tel"),h=document.getElementById("contact-whatsapp"),u=document.getElementById("contact-phone");d&&(d.textContent=`WhatsApp — ${o}`),m&&(m.textContent=o),l&&(l.href=`tel:${o.replace(/\s/g,"")}`),u&&(u.placeholder=o),h&&(h.href=`https://wa.me/${a}?text=${encodeURIComponent(i("wa.trial"))}`)}catch{}}n(),e.addEventListener("submit",r=>{var v;r.preventDefault();const s=document.getElementById("contact-name").value.trim(),d=document.getElementById("contact-phone").value.trim(),m=document.getElementById("contact-message").value.trim(),l=((v=document.getElementById("contact-package"))==null?void 0:v.value.trim())||"";if(!s||!d||!m){t.textContent=i("form.error"),t.className="form-msg err";return}const h=i("wa.formIntro").replace("{name}",s).replace("{phone}",d),u=l?`

Pako: ${l}`:"",p=encodeURIComponent(`${h}${u}

${m}

${i("wa.formSuffix")}`);window.open(`https://wa.me/${a}?text=${p}`,"_blank","noopener,noreferrer"),t.textContent=i("form.success"),t.className="form-msg ok",e.reset()})}const _={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},ee={..._,...J,...X},te={"stoku-faturat-dhe-skanimi-me-ai":`
  ...
  `},oe={...te,...ie,...ae},C=[{slug:"stoku-faturat-dhe-skanimi-me-ai",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku, Faturat dhe Skanimi me AI: Kontroll më i Lehtë për Restorantin",date:"06 maj 2026"},en:{category:"MANAGEMENT",title:"Inventory, Invoices & AI Scanning: Easier Control for Your Restaurant",date:"06 May 2026"}},{slug:"aplikacion-offline-me-sync",variant:"mobile",sq:{category:"POS & TEKNOLOGJI",title:"Aplikacion Offline me Sync për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Offline App with Sync for Restaurants",date:"06 May 2026"}},{slug:"program-pos-falas",variant:"pos",sq:{category:"POS & TEKNOLOGJI",title:"Program POS Falas për Restorante",date:"06 maj 2026"},en:{category:"POS & TECHNOLOGY",title:"Free POS Software for Restaurants",date:"06 May 2026"}},{slug:"5-arsye-pos",variant:"analytics",sq:{category:"MENAXHIM",title:"5 Arsye pse çdo restorant ka nevojë për POS",date:"05 maj 2026"},en:{category:"MANAGEMENT",title:"5 Reasons Every Restaurant Needs a POS System",date:"05 May 2026"}},{slug:"porosite-klienteve",variant:"mobile",sq:{category:"FUNKSIONALITETE",title:"Porositë e Klientëve: Klientët porosisin direkt nga telefoni",date:"04 maj 2026"},en:{category:"FEATURES",title:"Customer Orders: Guests Order Directly from Their Phone",date:"04 May 2026"}},{slug:"meny-digjitale-qr",variant:"qr",sq:{category:"TEKNOLOGJI",title:"Meny Digjitale me QR Code",date:"03 maj 2026"},en:{category:"TECHNOLOGY",title:"Digital Menu with QR Code",date:"03 May 2026"}},{slug:"skanoni-menyne-me-ai",variant:"scan",sq:{category:"TEKNOLOGJI",title:"Skanoni Menunë me AI: Shtoni 50 Produkte në 2 Minuta",date:"28 mars 2026"},en:{category:"TECHNOLOGY",title:"Scan Your Menu with AI: Add 50 Products in 2 Minutes",date:"28 March 2026"}},{slug:"stoku-menaxhimi-inventarit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Stoku: Si të Menaxhoni Inventarin e Restorantit pa Humbje",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Inventory: How to Manage Restaurant Stock Without Losses",date:"28 March 2026"}},{slug:"zbritjet-ne-restorante",variant:"pos",sq:{category:"MENAXHIM",title:"Zbritjet në Restorante: Si të Rrisni Shitjet me Oferta të Zgjuara",date:"28 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Discounts: Grow Sales with Smart Offers",date:"28 March 2026"}},{slug:"analitika-ne-restorante",variant:"analytics",sq:{category:"ANALITIKË",title:"Analitika në Restorante: Nga të Dhënat te Vendime më të Mira",date:"27 mars 2026"},en:{category:"ANALYTICS",title:"Restaurant Analytics: From Data to Better Decisions",date:"27 March 2026"}},{slug:"bashko-tavolina",variant:"tables",sq:{category:"VEÇORI",title:"Bashko Tavolina: Si të Kombinosh Porositë pa Ndërprerje",date:"27 mars 2026"},en:{category:"FEATURES",title:"Merge Tables: Combine Orders Without Disruption",date:"27 March 2026"}},{slug:"identifikim-stafi",variant:"login",sq:{category:"VEÇORI",title:"Identifikim Stafi: PIN, RFID apo Fjalëkalim — Cila Metodë për Çfarë?",date:"27 mars 2026"},en:{category:"FEATURES",title:"Staff Login: PIN, RFID or Password — Which Method for What?",date:"27 March 2026"}},{slug:"librat-kontabel-atk",variant:"brand",sq:{category:"KONTABILITET",title:"Librat Kontabël për ATK: Si i Gjeneron Revolution Automatikisht",date:"27 mars 2026"},en:{category:"ACCOUNTING",title:"Accounting Books for Tax Authorities: How Revolution Generates Them Automatically",date:"27 March 2026"}},{slug:"raportet-e-restorantit",variant:"dashboard",sq:{category:"MENAXHIM",title:"Raportet e Restorantit: Si të Kuptosh Biznesin Tënd me Numra",date:"27 mars 2026"},en:{category:"MANAGEMENT",title:"Restaurant Reports: Understand Your Business by the Numbers",date:"27 March 2026"}},{slug:"split-bill",variant:"pos",sq:{category:"UDHËZUES",title:"Split Bill: Si të Ndash Faturën pa Konfuzion",date:"27 mars 2026"},en:{category:"GUIDE",title:"Split Bill: Divide the Check Without Confusion",date:"27 March 2026"}}];function ne(e){return e==="en"?oe:ee}function W(e,t){const a=e[t]??e.sq,o=ne(t)[e.slug];return o?{slug:e.slug,variant:e.variant,category:a.category,title:a.title,date:a.date,content:o}:null}function re(e,t=k()){const a=C.find(o=>o.slug===e);return a?W(a,t):null}function se(e=k()){return C.map(t=>W(t,e)).filter(Boolean)}const le=f("images/articles/program-pos-falas.jpg");function he(e){return f(`images/articles/${e}.jpg`)}function D(e,{alt:t="",loading:a="lazy",className:o="article-photo"}={}){const n=t.replace(/"/g,"&quot;");return`<img src="${he(e)}" alt="${n}" class="${o}" loading="${a}" onerror="this.onerror=null;this.src='${le}';" />`}const ue=f("images/hero.jpg"),pe=["p1","p2","p3","p4"],L={p1:["f1","f2","f3","f4","f5","f6"],p2:["incl","f1","f2","f3","f4","f5","f6"],p3:["incl","f1","f2","f3","f4","f5","f6"],p4:["incl","f1","f2","f3","f4","f5","f6"]},de={p1:["f1","f2","f3","f4","f5"],p2:["incl","f1","f2","f3","f4"],p3:["incl","f1","f2","f3","f4"],p4:["incl","f1","f2","f3","f4"]};function B(e,{keys:t}={}){const a=`packages.${e}`;return(t??L[e]??[]).map(n=>i(`${a}.${n}`)).filter(Boolean).map(n=>`<li>${n}</li>`).join("")}function b(e){const t=`packages.${e}`,a=i(`${t}.tagline`);return`
    ...
    >
      ...
      <ul class="package-list">${B(e,{keys:de[e]})}</ul>
      <span class="btn btn-ghost package-select-btn">${i("cta.choosePackage")}</span>
    </article>
  `}function w(e,t,a,o){const n=i(t);return`
    <article class="how-card">
      <div class="how-card-photo">
        <img src="${f(e)}" alt="${n}" loading="lazy" />
      </div>
      <h3>${n}</h3>
      <p>${i(a)}</p>
      <a class="how-card-link" href="${o}">${i("how.readManual")}</a>
    </article>
  `}function me(){var m;const e=document.querySelectorAll(".package-card[data-package]"),t=document.getElementById("package-detail"),a=document.getElementById("package-detail-name"),o=document.getElementById("package-detail-summary"),n=document.getElementById("package-detail-list"),r=document.getElementById("contact-package");if(!e.length||!t)return;const s=l=>{const h=`packages.${l}`;if(e.forEach(u=>{const p=u.dataset.package===l;u.classList.toggle("selected",p),u.setAttribute("aria-pressed",p?"true":"false")}),a.textContent=i(`${h}.name`),o){const u=i(`${h}.summary`);o.textContent=u,o.hidden=!u}n.innerHTML=B(l,{keys:L[l]}),t.hidden=!1,r&&(r.value=i(`${h}.name`)),sessionStorage.setItem("selectedPackage",l)};e.forEach(l=>{const h=l.dataset.package,u=p=>{var v;(v=p==null?void 0:p.target)!=null&&v.closest(".how-card-link")||s(h)};l.addEventListener("click",u),l.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),s(h))})}),(m=document.getElementById("package-detail-cta"))==null||m.addEventListener("click",()=>{var l,h;(l=document.getElementById("kontakt"))==null||l.scrollIntoView({behavior:"smooth"}),(h=document.getElementById("contact-message"))==null||h.focus()});const d=sessionStorage.getItem("selectedPackage");d&&pe.includes(d)&&s(d)}function N(){var a,o;const e=se(),t=k();document.title=i("meta.title"),(o=document.querySelector('meta[name="description"]'))==null||o.setAttribute("content",((a=S[t])==null?void 0:a["meta.description"])??S.sq["meta.description"]),document.getElementById("app").innerHTML=`
    ${A({activeNav:"home"})}
    <main>
      ...
      <section class="articles" id="artikuj">
        <div class="container">
          ...
          <div class="article-grid">
            ${e.map(n=>`
                  <a class="article-card" href="${Y(n.slug)}" data-navigate>
    ...
    ${T()}
    ${K()}
  `,M(),x(),$(),Z(),I(),me(),window.location.hash?requestAnimationFrame(()=>{var n;(n=document.querySelector(window.location.hash))==null||n.scrollIntoView({behavior:"smooth"})}):window.scrollTo(0,0)}function ce(e){const t=re(e);if(!t){N();return}document.title=`${t.title} — Revolution POS`,document.getElementById("app").innerHTML=`
    ${A({activeNav:"blog"})}
    ...
    ${T()}
    ${K()}
  `,M(),x(),$(),I(),window.scrollTo(0,0)}const ge={privacy:{sq:{title:"Privatësia e të dhënave",updated:"Përditësuar: qershor 2026",content:`
      ...
      `}}};function ke(e){const t=ge[e];if(!t)return null;const a=k();return t[a]??t.sq}function H(e){const t=ke(e);if(!t){N();return}document.title=`${t.title} — Revolution Invest POS`,document.getElementById("app").innerHTML=`
    ${A({activeNav:"home"})}
    ...
    ${T()}
    ${K()}
  `,M(),x(),$(),I(),window.scrollTo(0,0)}R("/",()=>N());R("/privacy",()=>H("privacy"));R("/terms",()=>H("terms"));R("/blog/:slug",({slug:e})=>ce(e));Q();
