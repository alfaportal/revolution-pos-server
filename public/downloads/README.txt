...
Rrjedha:
  ...
  3. Publikon KAFENE-Setup.exe te alfaportal/revolution-restaurant-server
...
URL tipike e burimit intern:
  https://github.com/alfaportal/revolution-restaurant-server/releases/download/setup-vX.Y.Z/KAFENE-Setup.exe

Secret i nevojshëm (restaurant-system → Settings → Secrets):
  SETUP_PUBLISH_TOKEN = GitHub PAT me contents:write te revolution-restaurant-server
...
Opsionale (Railway):
  SETUP_RELEASE_REPO=alfaportal/revolution-restaurant-server
